...
$db_config['dbport'] = '';
$db_config['dbname'] = 'sharecode2';
$db_config['dbsystem'] = 'sharecode2';
...
$global_config['sitekey'] = '5a4c6b1c5c5315e3af149cf1b3d0519f';// Do not change sitekey!
...
define('URL_CONFIG', 'https://sharecode.vn');

define('API_WALLET_URL', 'http://sharecode.local/api.php');
define('API_WALLET_KEY', 'r8BK1KOaZb16jxo68hmNK9T6A0xAYoQy');
define('API_WALLET_SECRET', 'd2GT2CERy6D8T6IY8VN7ryOayE9364Rz');
