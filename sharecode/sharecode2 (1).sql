...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 29, 2025 lúc 06:52 PM
...
(1, 1, 'r8BK1KOaZb16jxo68hmNK9T6A0xAYoQy', 'v_lFE64Rv7XuE3RPzawIIDMIZHE3nHZDjUIpi8_Eu2A3_aJOJQ6lHjGwYZhtswfV', '[]', 'password_verify', 1752994823, 0, 1753441153);
...
(1, 'ckeditor5-classic', 1, 0, NULL, 'adobe,archives,audio,documents,images,real,video|1|1|1', 'Administrator', 'siteinfo', '', 0, 0, 0, '', '', 0, '', '', '2a8674a63ca7bea52007f775075ed898', 1753806422, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36');
...
('sys', 'global', 'timestamp', '1753550030'),
...
('sys', 'site', 'cronjobs_last_time', '1753806397'),
...
('vi', 'global', 'smtp_password', 'aQDbrUsB0xnTh_b-lXErDw,,'),
...
('vi', 'sharecode', 'allow_guest_submit', '0'),
('vi', 'sharecode', 'allowed_extensions', 'zip,rar,7z,tar,gz'),
('vi', 'sharecode', 'auto_approve_reviews', '1'),
...
('browser', 'bots', 0, 0, 0),
('browser', 'chrome', 1753806397, 57, 57),
...
('day', '18', 0, 0, 0),
('day', '19', 0, 0, 0),
('day', '20', 1753029864, 28, 28),
('day', '21', 1753115954, 6, 6),
('day', '22', 1753173107, 9, 9),
('day', '23', 0, 0, 0),
('day', '24', 0, 0, 0),
('day', '25', 1753461804, 9, 9),
('day', '26', 1753548780, 3, 3),
('day', '27', 1753596275, 6, 6),
('day', '28', 0, 0, 0),
('day', '29', 1753806397, 2, 2),
('day', '30', 0, 0, 0),
('day', '31', 0, 0, 0),
('dayofweek', 'Friday', 1753461804, 9, 9),
('dayofweek', 'Monday', 1753115954, 6, 6),
('dayofweek', 'Saturday', 1753548780, 3, 3),
('dayofweek', 'Sunday', 1753596275, 34, 34),
('dayofweek', 'Thursday', 0, 0, 0),
('dayofweek', 'Tuesday', 1753806397, 11, 11),
('dayofweek', 'Wednesday', 0, 0, 0),
('hour', '00', 1753550654, 0, 0),
('hour', '01', 1752951161, 0, 0),
...
('hour', '07', 0, 0, 0),
('hour', '08', 0, 0, 0),
('hour', '09', 1753582744, 0, 0),
('hour', '10', 0, 0, 0),
('hour', '11', 1753589932, 0, 0),
('hour', '12', 1753594459, 0, 0),
('hour', '13', 1753596275, 0, 0),
('hour', '14', 1753774216, 1, 1),
('hour', '15', 1753173107, 0, 0),
('hour', '16', 1753002223, 0, 0),
('hour', '17', 1753440655, 0, 0),
('hour', '18', 1753441709, 0, 0),
('hour', '19', 1753016287, 0, 0),
('hour', '20', 1753105957, 0, 0),
('hour', '21', 1753107807, 0, 0),
('hour', '22', 1753112302, 0, 0),
('hour', '23', 1753806397, 1, 1),
('month', 'Apr', 0, 0, 0),
('month', 'Aug', 0, 0, 0),
('month', 'Dec', 0, 0, 0),
('month', 'Feb', 0, 0, 0),
...
('os', 'winvista', 0, 0, 0),
('os', 'winxp', 0, 0, 0),
('total', 'hits', 1753806397, 63, 63),
('year', '2025', 1753806397, 63, 63),
('year', '2026', 0, 0, 0),
('year', '2027', 0, 0, 0),
('year', '2028', 0, 0, 0),
('year', '2029', 0, 0, 0),
...
(1, 1752944348, 5, 0, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1753806399, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL'),
(2, 1752944348, 1440, 0, 'dump_autobackup.php', 'cron_dump_autobackup', '', 0, 1, 1, 1753774218, 1, 'Tự động lưu CSDL'),
(3, 1752944348, 60, 0, 'temp_download_destroy.php', 'cron_auto_del_temp_download', '', 0, 1, 1, 1753806399, 1, 'Xóa các file tạm trong thư mục tmp'),
(4, 1752944348, 30, 0, 'ip_logs_destroy.php', 'cron_del_ip_logs', '', 0, 1, 1, 1753806399, 1, 'Xóa IP log files, Xóa các file nhật ký truy cập'),
(5, 1752944348, 1440, 0, 'error_log_destroy.php', 'cron_auto_del_error_log', '', 0, 1, 1, 1753774218, 1, 'Xóa các file error_log quá hạn'),
(6, 1752944348, 360, 0, 'error_log_sendmail.php', 'cron_auto_sendmail_error_log', '', 0, 1, 0, 0, 0, 'Gửi email các thông báo lỗi cho admin'),
(7, 1752944348, 60, 0, 'ref_expired_del.php', 'cron_ref_expired_del', '', 0, 1, 1, 1753806399, 1, 'Xóa các referer quá hạn'),
(8, 1752944348, 60, 0, 'check_version.php', 'cron_auto_check_version', '', 0, 1, 1, 1753806399, 1, 'Kiểm tra phiên bản NukeViet'),
(9, 1752944348, 1440, 0, 'notification_autodel.php', 'cron_notification_autodel', '', 0, 1, 1, 1753774218, 1, 'Xóa thông báo cũ'),
(10, 1752944348, 1440, 0, 'remove_expired_inform.php', 'cron_remove_expired_inform', '', 0, 1, 1, 1753774218, 1, 'Xóa thông báo quá hạn'),
(11, 1752944348, 60, 0, 'apilogs_autodel.php', 'cron_apilogs_autodel', '', 0, 1, 1, 1753806399, 1, 'Xóa các API-log hết hạn'),
(12, 1752944348, 60, 0, 'expadmin_handling.php', 'cron_expadmin_handling', '', 0, 1, 1, 1753806399, 1, 'Xử lý admin quá hạn');
...
('k1kvt8rmhg77115dt8bnsludnd', 0, 'guest', 1753806397);
...
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}H0Z96LuzH4Iv4hg56c9RFHGg0oWLLVkxKgf5AzmtpLdSweGD/FYktMNlXg9a3lIDcdFhUV3G1hMsmC4Aqw9+EmQ5Mzk=', 'nguyenthehuy977943@gmail.com', '', 'admin', '', '', '', 0, '', 1752944454, '231', '2131', '', 0, 1, '1,4', 1, 0, '', 0, 0, 'af4214ba992044bb0b567013dd632fa6', 1753441149, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '', '', 0, 0, 0, '', 1752944454, 0, 1752944454, 0, -3, 'SYSTEM', ''),
(2, 4, 'huydepzai121', '480d6f6837bbe11733ec1b1659afa68e', '{SSHA512}7ogsmfgzF5FbeAT4RfAbTYyOX3lYFiJ0j1iYGi2m+FU/gdZxRSwpq6aWXJhaCM+5TNWewjHH+KtRi9Z0lDGbJjQ3Y2I=', 'sang90661@st.vimaru.edu.vn', '', 'Hải', 'Nguyễn', 'M', '', 678474000, '', 1753021239, '213', '321321', '', 0, 1, '4', 1, 0, '', 0, 0, '9bea625d28e9d78666b30bb8b8a58779', 1753166683, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '', '', 0, 0, 0, '', 1753021239, 0, 1753021239, 0, -1, 'SYSTEM', '');
...
(2, '5b8098f3ffb8b7fdb898eee66352b6fd', 1753166683, 0, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '127.0.0.1', '');
...
(80, 'purchase', 'purchase', 'Purchase', '', '', 'sharecode', 1, 1, 7, ''),
...
(92, 'history', 'history', 'History', '', '', 'sharecode', 1, 1, 8, ''),
(93, 'author', 'author', 'Author', '', '', 'sharecode', 1, 1, 10, ''),
(94, 'list-view', 'list-view', 'List-view', '', '', 'sharecode', 1, 0, 11, ''),
(95, 'submit', 'submit', 'Submit', '', '', 'sharecode', 1, 1, 9, ''),
(96, 'main', 'main', 'Main', '', '', 'home', 1, 1, 1, ''),
(97, 'dashboard', 'dashboard', 'Dashboard', '', '', 'sharecode', 1, 1, 13, ''),
...
INSERT INTO `nv4_vi_sharecode_categories` (`id`, `parentid`, `title`, `alias`, `description`, `image`, `weight`, `status`, `add_time`) VALUES
(1, 0, 'PHP Scripts', 'php-scripts', 'Các script và ứng dụng PHP', '', 1, 1, 1753589207),
(2, 0, 'JavaScript', 'javascript', 'Thư viện và script JavaScript', '', 2, 1, 1753589207),
(3, 0, 'HTML Templates', 'html-templates', 'Template HTML responsive', '', 3, 1, 1753589207),
(4, 0, 'CSS Frameworks', 'css-frameworks', 'Framework và thư viện CSS', '', 4, 1, 1753589207),
(5, 0, 'WordPress', 'wordpress', 'Theme và plugin WordPress', '', 5, 1, 1753589207),
(6, 0, 'Mobile Apps', 'mobile-apps', 'Ứng dụng di động', '', 6, 1, 1753589207),
(7, 0, 'PHP Scripts', 'php-scripts', 'Các script và ứng dụng PHP chất lượng cao cho website và ứng dụng web', '', 1, 1, 1753589207),
(8, 0, 'JavaScript', 'javascript', 'Thư viện và script JavaScript hiện đại', '', 2, 1, 1753589207),
(9, 0, 'HTML Templates', 'html-templates', 'Template HTML responsive và hiện đại', '', 3, 1, 1753589207),
(10, 0, 'CSS Frameworks', 'css-frameworks', 'Framework và thư viện CSS', '', 4, 1, 1753589207),
(11, 0, 'WordPress', 'wordpress', 'Theme và plugin WordPress', '', 5, 1, 1753589207),
(12, 0, 'Mobile Apps', 'mobile-apps', 'Ứng dụng di động cho Android và iOS', '', 6, 1, 1753589207);
...
CREATE TABLE `nv4_vi_sharecode_purchases` (
  ...
  `purchase_time` int(11) DEFAULT 0,
...
INSERT INTO `nv4_vi_sharecode_reviews` (`id`, `source_id`, `userid`, `username`, `title`, `content`, `rating`, `status`, `add_time`, `update_time`) VALUES
(1, 1, 1, 'admin', 'Code chất lượng cao', 'Code rất sạch và dễ hiểu. Documentation đầy đủ, cài đặt dễ dàng. Recommend cho ai cần một CMS đơn giản nhưng mạnh mẽ.', 5, 1, 1753589207, 0),
(2, 1, 1, 'admin', 'Tính năng đầy đủ', 'Tính năng đầy đủ, giao diện admin đẹp. Chỉ có điều muốn thêm tính năng multi-site management.', 4, 1, 1753589207, 0),
(3, 2, 1, 'admin', 'Excellent platform!', 'Đã sử dụng cho 3 dự án và rất hài lòng. Performance tốt, bảo mật chắc chắn, tích hợp payment gateway dễ dàng.', 5, 1, 1753589207, 0),
(4, 3, 1, 'admin', 'Blog system tuyệt vời', 'Blog system đơn giản nhưng hiệu quả. Dễ customize và extend thêm tính năng. Editor WYSIWYG rất mượt.', 4, 1, 1753589207, 0),
(5, 4, 1, 'admin', 'jQuery gallery xuất sắc', 'jQuery gallery tuyệt vời, dễ customize. Lightbox smooth và responsive tốt. Performance trên mobile rất ổn.', 5, 1, 1753589207, 0),
(6, 5, 1, 'admin', 'React component chất lượng', 'React data table component rất mạnh mẽ. Virtual scrolling làm việc tốt với big data. Export feature rất tiện.', 5, 1, 1753589207, 0);
...
CREATE TABLE `nv4_vi_sharecode_sources` (
  ...
  `download_link_type` enum('internal','external') DEFAULT 'internal',
  `demo_link` varchar(255) DEFAULT '',
  `keywords` varchar(255) DEFAULT '',
  `fee_type` enum('free','paid','contact') DEFAULT 'free',
  `fee_amount` decimal(15,2) DEFAULT 0.00,
  `contact_phone` varchar(20) DEFAULT '',
  `contact_email` varchar(100) DEFAULT '',
  `contact_skype` varchar(100) DEFAULT '',
  `contact_telegram` varchar(100) DEFAULT '',
  `contact_zalo` varchar(20) DEFAULT '',
  `contact_facebook` varchar(255) DEFAULT '',
  ...
  `add_time` int(11) DEFAULT 0,
  `update_time` int(11) DEFAULT 0,
  `last_download` int(11) DEFAULT 0,
  `userid` int(11) DEFAULT 0,
...
INSERT INTO `nv4_vi_sharecode_sources` (`id`, `catid`, `title`, `alias`, `description`, `content`, `image`, `file_path`, `file_name`, `file_size`, `download_link`, `download_link_type`, `demo_link`, `keywords`, `fee_type`, `fee_amount`, `contact_phone`, `contact_email`, `contact_skype`, `contact_telegram`, `contact_zalo`, `contact_facebook`, `contact_website`, `contact_address`, `num_view`, `num_download`, `avg_rating`, `status`, `add_time`, `update_time`, `last_download`, `userid`, `username`) VALUES
(1, 1, 'PHP CMS System', 'php-cms-system', 'Hệ thống quản lý nội dung (CMS) được xây dựng hoàn toàn bằng PHP và MySQL.', 'Đây là một giải pháp hoàn chỉnh cho việc quản lý website với giao diện admin hiện đại và nhiều tính năng mạnh mẽ như: quản lý người dùng, SEO tối ưu, bảo mật cao, responsive design.', '', '', '', 0, '', 'internal', 'https://demo.example.com/cms', '', 'free', 0.00, '', '', '', '', '', '', '', NULL, 1235, 345, 4.80, 1, 1753589207, 0, 0, 1, 'admin'),
(2, 1, 'E-commerce Platform', 'ecommerce-platform', 'Hệ thống bán hàng trực tuyến với đầy đủ tính năng thanh toán, quản lý sản phẩm, đơn hàng.', 'Platform thương mại điện tử hoàn chỉnh với tích hợp nhiều cổng thanh toán (VNPay, PayPal, Stripe), quản lý kho hàng, báo cáo doanh thu, hệ thống khuyến mãi và nhiều tính năng khác.', '', '', '', 0, '', 'internal', 'https://demo.example.com/shop', '', 'contact', 199000.00, '0828164604', 'nguyenthehuy977943@gmail.com', '', '', '0828164604', '', '', '', 894, 156, 4.90, 1, 1753589207, 1753590762, 0, 1, 'admin'),
(3, 1, 'Blog Management System', 'blog-management-system', 'Hệ thống blog đơn giản với editor WYSIWYG và quản lý bài viết hiệu quả.', 'Blog system với editor WYSIWYG mạnh mẽ, hệ thống comment, phân loại bài viết, SEO tối ưu và giao diện responsive đẹp mắt.', '', '', '', 0, '', 'internal', '', '', 'free', 0.00, '', '', '', '', '', '', '', NULL, 567, 189, 4.60, 1, 1753589207, 0, 0, 1, 'admin'),
(4, 2, 'jQuery Photo Gallery', 'jquery-photo-gallery', 'Plugin jQuery tạo gallery hình ảnh với lightbox và slideshow chuyên nghiệp.', 'Gallery plugin với nhiều hiệu ứng chuyển đổi, lightbox responsive, hỗ trợ touch gesture trên mobile, lazy loading và tối ưu performance.', '', '', '', 0, '', 'internal', 'https://demo.example.com/gallery', '', 'free', 0.00, '', '', '', '', '', '', '', NULL, 789, 234, 4.70, 1, 1753589207, 0, 0, 1, 'admin'),
(5, 2, 'React Data Table', 'react-data-table', 'Component React cho bảng dữ liệu với tính năng sort, filter, pagination.', 'Data table component mạnh mẽ với virtual scrolling, export Excel/PDF, inline editing, custom cell renderer và nhiều tính năng khác.', '', '', '', 0, '', 'internal', 'https://demo.example.com/datatable', '', 'paid', 89000.00, '', '', '', '', '', '', '', NULL, 543, 98, 4.80, 1, 1753589207, 0, 0, 1, 'admin'),
(6, 3, 'Bootstrap Business Template', 'bootstrap-business-template', 'Template HTML Business responsive với Bootstrap và nhiều component.', 'Template business hoàn chỉnh với 15+ trang mẫu, animation CSS3, contact form, testimonials, portfolio showcase và tối ưu SEO.', '', '', '', 0, '', 'internal', 'https://demo.example.com/business', '', 'paid', 149000.00, '', '', '', '', '', '', '', NULL, 654, 123, 4.90, 1, 1753589207, 0, 0, 1, 'admin'),
(7, 5, 'WordPress Corporate Theme', 'wordpress-corporate-theme', 'Theme WordPress cho doanh nghiệp với page builder và SEO tối ưu.', 'Theme doanh nghiệp với Visual Composer, WooCommerce ready, multilingual support, custom post types và optimization cho tốc độ.', '', '', '', 0, '', 'internal', 'https://demo.example.com/wp-corporate', '', 'paid', 299000.00, '', '', '', '', '', '', '', NULL, 432, 78, 4.80, 1, 1753589207, 0, 0, 1, 'admin'),
(8, 6, 'React Native Food App', 'react-native-food-app', 'Ứng dụng đặt đồ ăn React Native với tích hợp thanh toán và tracking.', 'Food delivery app với real-time tracking, multiple payment methods, push notifications, rating system và admin dashboard.', '', '', '', 0, '', 'internal', '', '', 'paid', 499000.00, '', '', '', '', '', '', '', NULL, 321, 45, 4.90, 1, 1753589207, 0, 0, 1, 'admin');
...
CREATE TABLE `nv4_vi_sharecode_tags` (
  ...
  `weight` int(11) DEFAULT 0,
  `status` tinyint(4) DEFAULT 1,
  `total_sources` int(11) DEFAULT 0,
  `add_time` int(11) DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `nv4_vi_sharecode_tags` (`id`, `name`, `alias`, `description`, `weight`, `status`, `total_sources`, `add_time`) VALUES
(1, 'responsive', 'responsive', 'Hỗ trợ responsive design', 0, 1, 3, 1753589207),
(2, 'bootstrap', 'bootstrap', 'Sử dụng Bootstrap framework', 0, 1, 1, 1753589207),
(3, 'jquery', 'jquery', 'Sử dụng jQuery library', 0, 1, 1, 1753589207),
(4, 'admin', 'admin', 'Giao diện quản trị', 0, 1, 1, 1753589207),
(5, 'ecommerce', 'ecommerce', 'Thương mại điện tử', 0, 1, 1, 1753589207),
(6, 'cms', 'cms', 'Hệ thống quản lý nội dung', 0, 1, 2, 1753589207),
(7, 'php', 'php', 'Ngôn ngữ lập trình PHP', 0, 1, 3, 1753589207),
(8, 'mysql', 'mysql', 'Hệ quản trị cơ sở dữ liệu MySQL', 0, 1, 1, 1753589207);
...
(1, 1684770292, 0, 1, 'VND', 19868888768, 3321660, 19865567108, '', ''),
(2, 1753026829, 1, 1, 'VND', 200000, 199000, 1000, '', ''),
