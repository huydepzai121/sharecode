...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 05, 2025 lúc 04:06 AM
...
--
-- Cơ sở dữ liệu: `sharecode3`
--
CREATE DATABASE IF NOT EXISTS `sharecode3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sharecode3`;
...
--
-- Đang đổ dữ liệu cho bảng `nv4_api_role`
--

INSERT INTO `nv4_api_role` (`role_id`, `role_md5title`, `role_type`, `role_object`, `role_title`, `role_description`, `role_data`, `log_period`, `flood_rules`, `addtime`, `edittime`, `status`) VALUES
(1, 'ec14d57de3983cc8148083d86ce2944e', 'private', 'admin', 'API_WALLET', '', '{\"sys\":[],\"vi\":{\"wallet\":[\"DeductBalance\",\"GetAllUserBalances\",\"GetUserBalance\"]}}', 0, '[]', 1752994808, 0, 1);
...
--
-- Đang đổ dữ liệu cho bảng `nv4_api_role_credential`
--

INSERT INTO `nv4_api_role_credential` (`id`, `userid`, `role_id`, `access_count`, `last_access`, `addtime`, `endtime`, `quota`, `status`) VALUES
(1, 1, 1, 257, 1759067321, 0, 0, 0, 1);
...
--
-- Đang đổ dữ liệu cho bảng `nv4_api_user`
--

INSERT INTO `nv4_api_user` (`id`, `userid`, `ident`, `secret`, `ips`, `method`, `addtime`, `edittime`, `last_access`) VALUES
(1, 1, 'r8BK1KOaZb16jxo68hmNK9T6A0xAYoQy', 'v_lFE64Rv7XuE3RPzawIIDMIZHE3nHZDjUIpi8_Eu2A3_aJOJQ6lHjGwYZhtswfV', '[]', 'password_verify', 1752994823, 0, 1759067321);
...
(1, 'ckeditor5-classic', 1, 0, NULL, 'adobe,archives,audio,documents,images,real,video|1|1|1', 'Administrator', 'siteinfo', '', 0, 0, 0, '', '', 0, '', '', 'd0e9de6b0e23768e1d05a6fdbcdf8335', 1759629895, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36');
...
(1, 'siteinfo', 'mod_siteinfo', 1, 1, 1, 1, '871fc88ea55193117948f4d1a7c6f264', 'fa-solid fa-server'),
(2, 'authors', 'mod_authors', 2, 1, 1, 1, '17ca6b0bf10e891f84856ff11d993d06', 'fa-solid fa-user-gear'),
(3, 'settings', 'mod_settings', 3, 1, 1, 0, 'edea25314673ff5eff287c0f04a3b5fc', 'fa-solid fa-gears'),
(4, 'database', 'mod_database', 4, 1, 0, 0, '2d5da6aa7bea6d8a47d9a5b47a446f48', 'fa-solid fa-database'),
(5, 'webtools', 'mod_webtools', 5, 1, 1, 0, 'c610dc81c670056ae504845e8e7f38b8', 'fa-solid fa-toolbox'),
(6, 'seotools', 'mod_seotools', 6, 1, 1, 0, '7c7c58b7d1b2ab6b53d84baa5c8f5d6c', 'fa-brands fa-searchengin'),
(7, 'language', 'mod_language', 7, 1, 1, 0, '0f7aa35ad20102994379f713dc3ea28c', 'fa-solid fa-language'),
(8, 'modules', 'mod_modules', 8, 1, 1, 0, '10cb7dea00087d6fc5534409a2f411b8', 'fa-solid fa-cubes'),
(9, 'themes', 'mod_themes', 9, 1, 1, 0, 'ac01a580523e24219e304345668f6bac', 'fa-solid fa-palette'),
(10, 'extensions', 'mod_extensions', 10, 1, 0, 0, 'c472d74fdb81b7f92ff70a6c9292137e', 'fa-solid fa-cubes-stacked'),
(11, 'upload', 'mod_upload', 11, 1, 1, 1, '608e15189149b7e2aab95b5a2734f7c0', 'fa-solid fa-folder-plus'),
(12, 'emailtemplates', 'mod_emailtemplates', 12, 1, 1, 0, '739b81009dbbd9da44095f7b53fc596b', 'fa-solid fa-at');
...
--
-- Đang đổ dữ liệu cho bảng `nv4_authors_vars`
--

INSERT INTO `nv4_authors_vars` (`id`, `admin_id`, `lang`, `theme`, `config_name`, `config_value`, `weight`) VALUES
(1, 1, 'all', 'admin_future', 'color_mode', 'light', 0);
...
(1, 'Mid-page advertisement', 1, 1, 'webnhanh.jpg', 'png', 'image/jpeg', 575, 72, '', '', 'http://webnhanh.vn', '_blank', '', 1752944348, 1752944348, 0, 0, 1, 1),
(2, 'Left-column advertisement', 2, 1, 'vinades.jpg', 'jpg', 'image/jpeg', 212, 400, '', '', 'https://vinades.vn', '_blank', '', 1752944348, 1752944348, 0, 0, 1, 2);
...
('sys', 'global', 'error_send_email', 'webmaster@sharecode.local'),
...
('sys', 'global', 'ftp_user_pass', '3A8OdbRwfMz44KGlqVriEA,,'),
...
('sys', 'global', 'my_domains', 'sharecode2.local,sharecode.local'),
...
('sys', 'global', 'timestamp', '1759149999'),
...
('sys', 'site', 'cronjobs_last_time', '1759629880'),
...
('sys', 'site', 'site_email', 'webmaster@sharecode.local'),
('sys', 'site', 'site_phone', ''),
...
('vi', 'global', 'site_theme', 'sharecode-bs5'),
('vi', 'global', 'smime_included', 'sendmail,mail'),
('vi', 'global', 'smtp_host', 'smtp.gmail.com'),
('vi', 'global', 'smtp_password', 'CWg2oMzLqhoiRfa--Df-2kfvpblhDta64RSEqYhZiXg,'),
('vi', 'global', 'smtp_port', '465'),
('vi', 'global', 'smtp_ssl', '1'),
('vi', 'global', 'smtp_username', 'nguyenthehuy977943@gmail.com'),
...
('vi', 'global', 'verify_peer_name_ssl', '0'),
('vi', 'global', 'verify_peer_ssl', '0'),
...
('vi', 'news', 'schema_type', 'newsarticle'),
('vi', 'news', 'setcomm', '4'),
...
('vi', 'sharecode', 'deekseek_api_key', 'sk-70326b2a0e35431bba8274e37f9e5e87'),
...
('browser', 'bots', 0, 0, 0),
('browser', 'chrome', 1759153368, 276, 276),
...
('country', 'ZM', 0, 0, 0),
('country', 'ZW', 0, 0, 0),
('country', 'ZZ', 1759153368, 282, 282),
('day', '01', 1756720960, 4, 4),
('day', '02', 1756828854, 16, 16),
('day', '03', 1756917578, 12, 12),
('day', '04', 1757004560, 10, 10),
('day', '05', 1757090536, 7, 7),
('day', '06', 1757099539, 7, 7),
('day', '07', 1757264184, 18, 18),
('day', '08', 0, 0, 0),
('day', '09', 1754752237, 0, 0),
('day', '10', 1754813078, 0, 0),
('day', '11', 1757591962, 4, 4),
('day', '12', 0, 0, 0),
('day', '13', 0, 0, 0),
('day', '14', 0, 0, 0),
('day', '15', 0, 0, 0),
('day', '16', 1755362787, 0, 0),
('day', '17', 1758044446, 1, 1),
('day', '18', 1755535764, 0, 0),
('day', '19', 1755621636, 0, 0),
('day', '20', 1755708362, 0, 0),
('day', '21', 1755710306, 0, 0),
('day', '22', 1758477308, 2, 2),
('day', '23', 1755946382, 0, 0),
('day', '24', 1756029725, 0, 0),
('day', '25', 1753461804, 0, 0),
('day', '26', 1756205227, 0, 0),
('day', '27', 1758990830, 10, 10),
('day', '28', 1759076746, 37, 37),
('day', '29', 1759153368, 7, 7),
('day', '30', 1756558403, 0, 0),
('day', '31', 1756636870, 0, 0),
('dayofweek', 'Friday', 1757090536, 19, 19),
('dayofweek', 'Monday', 1759153368, 30, 30),
('dayofweek', 'Saturday', 1758990830, 43, 43),
('dayofweek', 'Sunday', 1759076746, 106, 106),
('dayofweek', 'Thursday', 1757591962, 16, 16),
('dayofweek', 'Tuesday', 1756828854, 38, 38),
('dayofweek', 'Wednesday', 1758044446, 30, 30),
('hour', '00', 1759081062, 2, 2),
...
('hour', '10', 1756783409, 0, 0),
('hour', '11', 1759034388, 0, 0),
('hour', '12', 1759036353, 0, 0),
('hour', '13', 1759041137, 0, 0),
('hour', '14', 1759045044, 0, 0),
('hour', '15', 1759049253, 0, 0),
('hour', '16', 1759052364, 0, 0),
('hour', '17', 1759055694, 0, 0),
('hour', '18', 1759145323, 1, 1),
('hour', '19', 1759149558, 2, 2),
('hour', '20', 1759153368, 2, 2),
('hour', '21', 1759071343, 0, 0),
('hour', '22', 1759074945, 0, 0),
('hour', '23', 1759076746, 0, 0),
('month', 'Apr', 0, 0, 0),
('month', 'Aug', 1756636870, 84, 84),
('month', 'Dec', 0, 0, 0),
('month', 'Feb', 0, 0, 0),
('month', 'Jan', 0, 0, 0),
('month', 'Jul', 1753806397, 63, 63),
('month', 'Jun', 0, 0, 0),
('month', 'Mar', 0, 0, 0),
('month', 'May', 0, 0, 0),
('month', 'Nov', 0, 0, 0),
...
('os', 'winvista', 0, 0, 0),
('os', 'winxp', 0, 0, 0),
('total', 'hits', 1759153368, 282, 282),
('year', '2025', 1759153368, 282, 282),
('year', '2026', 0, 0, 0),
('year', '2027', 0, 0, 0),
('year', '2028', 0, 0, 0),
('year', '2029', 0, 0, 0),
...
(1, 1752944348, 5, 0, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1759629883, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL'),
(2, 1752944348, 1440, 0, 'dump_autobackup.php', 'cron_dump_autobackup', '', 0, 1, 1, 1759629883, 1, 'Tự động lưu CSDL'),
(3, 1752944348, 60, 0, 'temp_download_destroy.php', 'cron_auto_del_temp_download', '', 0, 1, 1, 1759629883, 1, 'Xóa các file tạm trong thư mục tmp'),
(4, 1752944348, 30, 0, 'ip_logs_destroy.php', 'cron_del_ip_logs', '', 0, 1, 1, 1759629883, 1, 'Xóa IP log files, Xóa các file nhật ký truy cập'),
(5, 1752944348, 1440, 0, 'error_log_destroy.php', 'cron_auto_del_error_log', '', 0, 1, 1, 1759629883, 1, 'Xóa các file error_log quá hạn'),
(6, 1752944348, 360, 0, 'error_log_sendmail.php', 'cron_auto_sendmail_error_log', '', 0, 1, 0, 0, 0, 'Gửi email các thông báo lỗi cho admin'),
(7, 1752944348, 60, 0, 'ref_expired_del.php', 'cron_ref_expired_del', '', 0, 1, 1, 1759629883, 1, 'Xóa các referer quá hạn'),
(8, 1752944348, 60, 0, 'check_version.php', 'cron_auto_check_version', '', 0, 1, 1, 1759629883, 1, 'Kiểm tra phiên bản NukeViet'),
(9, 1752944348, 1440, 0, 'notification_autodel.php', 'cron_notification_autodel', '', 0, 1, 1, 1759629883, 1, 'Xóa thông báo cũ'),
(10, 1752944348, 1440, 0, 'remove_expired_inform.php', 'cron_remove_expired_inform', '', 0, 1, 1, 1759629883, 1, 'Xóa thông báo quá hạn'),
(11, 1752944348, 60, 0, 'apilogs_autodel.php', 'cron_apilogs_autodel', '', 0, 1, 1, 1759629883, 1, 'Xóa các API-log hết hạn'),
(12, 1752944348, 60, 0, 'expadmin_handling.php', 'cron_expadmin_handling', '', 0, 1, 1, 1759629883, 1, 'Xử lý admin quá hạn');
...
(1, 1752944348, 0, 1, 1, 1, 'Email của hệ thống'),
(2, 1752944348, 0, 3, 1, 1, 'Email về quản trị'),
(3, 1752944348, 0, 2, 1, 1, 'Email về tài khoản'),
(4, 1752944348, 0, 4, 1, 1, 'Email của các module');
...
(1, 1, '127.0.0.1', 0, 1, 1752944468, 0, '');
...
(1, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1752944499),
(2, 'vi', 'modules', 'Thiết lập module mới wallet', '', '', 1, 1752944517),
(3, 'vi', 'modules', 'Thiết lập module mới wallet', '', '', 1, 1752944519),
(4, 'vi', 'modules', 'Thiết lập module mới sharecode', '', '', 1, 1752944607),
(5, 'vi', 'modules', 'Sửa module &ldquo;sharecode&rdquo;', '', '', 1, 1752944614),
(6, 'vi', 'upload', 'Upload file', 'uploads/wallet/logo_mb_new.png', '', 1, 1752944778),
(7, 'vi', 'wallet', 'Thêm tài khoản thành công', 'ID: 0', '', 1, 1752944784),
(8, 'vi', 'settings', 'Change System setting', '', '', 1, 1752944866),
(9, 'vi', 'themes', 'Thêm block', 'Name : global block latest', '', 1, 1752944910),
(10, 'vi', 'modules', 'Thứ tự module: sharecode', '20 -> 1', '', 1, 1752944949),
(11, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1752951542),
(12, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1752951749),
(13, 'vi', 'modules', 'Kích hoạt module \"wallet\"', 'Không', '', 1, 1752953477),
(14, 'vi', 'modules', 'Cài lại module \"wallet\"', '', '', 1, 1752953615),
(15, 'vi', 'modules', 'Kích hoạt module \"wallet\"', 'Có', '', 1, 1752953620),
(16, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1752987015),
(17, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1752988959),
(18, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1752991251),
(19, 'vi', 'myapi', 'Add API-role', '1: API_WALLET', '', 1, 1752994808),
(20, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753006118),
(21, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753017220),
(22, 'vi', 'users', 'log_add_user', 'userid 2', '', 1, 1753021239),
(23, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1753021255),
(24, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1753023099),
(25, 'vi', 'menu', 'Add row menu', 'Row menu id: 23 of Menu id: 1', '', 1, 1753024272),
(26, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1753026852),
(27, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1753029339),
(28, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753029352),
(29, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753105979),
(30, 'vi', 'themes', 'Thêm block', 'Name : Tìm kiếm', '', 1, 1753106024),
(31, 'vi', 'themes', 'Sửa block', 'Name : Tìm kiếm', '', 1, 1753106159),
(32, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753107585),
(33, 'vi', 'themes', 'Thêm block', 'Name : global block search', '', 1, 1753107960),
(34, 'vi', 'themes', 'Sửa block', 'Name : global block search', '', 1, 1753108011),
(35, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753108167),
(36, 'vi', 'themes', 'Sửa block', 'Name : Menu Site', '', 1, 1753108193),
(37, 'vi', 'themes', 'Sửa block', 'Name : Contact Default', '', 1, 1753108216),
(38, 'vi', 'themes', 'Sửa block', 'Name : Social icon', '', 1, 1753108221),
(39, 'vi', 'themes', 'Sửa block', 'Name : Thông báo', '', 1, 1753108226),
(40, 'vi', 'themes', 'Sửa block', 'Name : Đăng nhập người dùng', '', 1, 1753108229),
(41, 'vi', 'themes', 'Sửa block', 'Name : Các chuyên mục chính', '', 1, 1753108237),
(42, 'vi', 'themes', 'Sửa block', 'Name : Sản phẩm', '', 1, 1753108242),
(43, 'vi', 'themes', 'Sửa block', 'Name : Công ty chủ quản', '', 1, 1753108246),
(44, 'vi', 'modules', 'Thiết lập module mới home', '', '', 1, 1753115017),
(45, 'vi', 'modules', 'Sửa module &ldquo;home&rdquo;', '', '', 1, 1753115019),
(46, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753115951),
(47, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753115951),
(48, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753115952),
(49, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753116000),
(50, 'vi', 'themes', 'Thêm block', 'Name : global block search', '', 1, 1753116043),
(51, 'vi', 'themes', 'Sửa block', 'Name : global block search', '', 1, 1753116051),
(52, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753160705),
(53, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161494),
(54, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161494),
(55, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161494),
(56, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161495),
(57, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161495),
(58, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161583),
(59, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161584),
(60, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161617),
(61, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161618),
(62, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161634),
(63, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161634),
(64, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161654),
(65, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161654),
(66, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161654),
(67, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161655),
(68, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161675),
(69, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161675),
(70, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161675),
(71, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161703),
(72, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161808),
(73, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161809),
(74, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753161853),
(75, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753162055),
(76, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753162055),
(77, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753162284),
(78, 'vi', 'settings', 'Change System setting', '', '', 1, 1753162557),
(79, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753163683),
(80, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753163683),
(81, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753163768),
(82, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753163769),
(83, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753164135),
(84, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753164135),
(85, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753164135),
(86, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753164209),
(87, 'vi', 'sharecode', 'Approve Product', 'ID: 9 - WEBSITE bán hàng - Note: dá', '', 1, 1753164677),
(88, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753164689),
(89, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1753166683),
(90, 'vi', 'users', '[admin] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1753441149),
(91, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753459972),
(92, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753461331),
(93, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753462284),
(94, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753462284),
(95, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753462285),
(96, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753462285),
(97, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753462285),
(98, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753463599),
(99, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753550019),
(100, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753550030),
(101, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1753550030),
(102, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753582752),
(103, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753584648),
(104, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753585289),
(105, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1753587635),
(106, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753588713),
(107, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589100),
(108, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589124),
(109, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589130),
(110, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589144),
(111, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589152),
(112, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589159),
(113, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589173),
(114, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1753589207),
(115, 'vi', 'users', '[admin] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1753596275),
(116, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753774422),
(117, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753774683),
(118, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753776078),
(119, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1753776253),
(120, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753776259),
(121, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753776307),
(122, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1753778141),
(123, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1753806422),
(124, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1754153902),
(125, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754153908),
(126, 'vi', 'sharecode', 'add_tags', 'nguyen-the-huy', '', 1, 1754155592),
(127, 'vi', 'sharecode', 'edit_tags', 'php', '', 1, 1754155667),
(128, 'vi', 'sharecode', 'edit_tags', 'responsive', '', 1, 1754155678),
(129, 'vi', 'sharecode', 'DEL_TAG', '9', '', 1, 1754155690),
(130, 'vi', 'sharecode', 'add_multi_tags', 'test; test2', '', 1, 1754155704),
(131, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754156036),
(132, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754752445),
(133, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1754753004),
(134, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1754753004),
(135, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754754423),
(136, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754754704),
(137, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1754755077),
(138, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1754755124),
(139, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1754755442),
(140, 'vi', 'upload', 'Upload file', 'uploads/sharecode/top-code.jpg', '', 1, 1754756065),
(141, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754756456),
(142, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754756680),
(143, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754756720),
(144, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1754758522),
(145, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754758594),
(146, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1754759724),
(147, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1754808066),
(148, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1754808071),
(149, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1754811050),
(150, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755279952),
(151, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1755279982),
(152, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1755279988),
(153, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755280180),
(154, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755280330),
(155, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755280436),
(156, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755280609),
(157, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1755280712),
(158, 'vi', 'sharecode', 'add_tags', 'nguyen-the-huy', '', 1, 1755280725),
(159, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755362812),
(160, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755420518),
(161, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755424509),
(162, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755442003),
(163, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755443820),
(164, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755451693),
(165, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1755451993),
(166, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755452058),
(167, 'vi', 'settings', 'Email send config change', '', '', 1, 1755453268),
(168, 'vi', 'settings', 'Email send config change', '', '', 1, 1755454349),
(169, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755526582),
(170, 'vi', 'sharecode', 'DEL_TAG', '1', '', 1, 1755526651),
(171, 'vi', 'users', '[admin] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1755527682),
(172, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755529329),
(173, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755529607),
(174, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1755530382),
(175, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1755530401),
(176, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755533541),
(177, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755533605),
(178, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1755533632),
(179, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1755535245),
(180, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755535254),
(181, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755535509),
(182, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755536680),
(183, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1755536762),
(184, 'vi', 'login', '[nukeviet] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1755536789),
(185, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755538074),
(186, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755603791),
(187, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755606385),
(188, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755608018),
(189, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755610281),
(190, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755610900),
(191, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755611617),
(192, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755611723),
(193, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755612496),
(194, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755613235),
(195, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755614127),
(196, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755614480),
(197, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755614879),
(198, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755615307),
(199, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755616159),
(200, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755616302),
(201, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755616364),
(202, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755616403),
(203, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755617875),
(204, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1755619727),
(205, 'vi', 'sharecode', 'Approve Product', 'ID: 22 - dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa - Note: dsadsa', '', 1, 1755621087),
(206, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755672097),
(207, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755676483),
(208, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1755678383),
(209, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755706282),
(210, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1755706417),
(211, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755706991),
(212, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755706991),
(213, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755706992),
(214, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755706992),
(215, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755706992),
(216, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755706993),
(217, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707006),
(218, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707006),
(219, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707006),
(220, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707303),
(221, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707304),
(222, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707433),
(223, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707433),
(224, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707537),
(225, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707538),
(226, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707627),
(227, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707627),
(228, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707628),
(229, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707712),
(230, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707712),
(231, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707713),
(232, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707713),
(233, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707769),
(234, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707769),
(235, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707784),
(236, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707784),
(237, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707875),
(238, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755707875),
(239, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708186),
(240, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708187),
(241, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1755708263),
(242, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708326),
(243, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708342),
(244, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708342),
(245, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708566),
(246, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708566),
(247, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708567),
(248, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708598),
(249, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708598),
(250, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708598),
(251, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708806),
(252, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708806),
(253, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708806),
(254, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708806),
(255, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708806),
(256, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755708807),
(257, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709199),
(258, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709199),
(259, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709199),
(260, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709546),
(261, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709547),
(262, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709572),
(263, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709572),
(264, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709685),
(265, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709685),
(266, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709998),
(267, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709998),
(268, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755709998),
(269, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710086),
(270, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710087),
(271, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710087),
(272, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710087),
(273, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710087),
(274, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710088),
(275, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710088),
(276, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710088),
(277, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710092),
(278, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710093),
(279, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710093),
(280, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710094),
(281, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710094),
(282, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710094),
(283, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710382),
(284, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710382),
(285, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755710382),
(286, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755878428),
(287, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1755879417),
(288, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1755879424),
(289, 'vi', 'upload', 'Upload file', 'uploads/sharecode/499478119_2106000256583165_7079072595933555695_n.jpg', '', 1, 1755885034),
(290, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755916439),
(291, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1755917998),
(292, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1755920047),
(293, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1755946521),
(294, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756014673),
(295, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756018803),
(296, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756221485),
(297, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756226248),
(298, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756269106),
(299, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756270940),
(300, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756273218),
(301, 'vi', 'themes', 'Thêm block', 'Name : global block chat', '', 1, 1756273253),
(302, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756273274),
(303, 'vi', 'themes', 'Thêm block', 'Name : global block chat', '', 1, 1756273602),
(304, 'vi', 'themes', 'Sửa block', 'Name : global block chat', '', 1, 1756274279),
(305, 'vi', 'themes', 'Thiết lập layout theme: \"default\"', '', '', 1, 1756281772),
(306, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1756282177),
(307, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756282999),
(308, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1756284440),
(309, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756285662),
(310, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756285670),
(311, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286026),
(312, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756286032),
(313, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286037),
(314, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286037),
(315, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286038),
(316, 'vi', 'themes', 'Thiết lập giao diện theme: \"sharecode\"', '', '', 1, 1756286073),
(317, 'vi', 'themes', 'Kích hoạt theme: \"sharecode\"', '', '', 1, 1756286107),
(318, 'vi', 'themes', 'Kích hoạt theme: \"default\"', '', '', 1, 1756286148),
(319, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286299),
(320, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286300),
(321, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286300),
(322, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286301),
(323, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286361),
(324, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286361),
(325, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286361),
(326, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286429),
(327, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286429),
(328, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286429),
(329, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756286450),
(330, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756286487),
(331, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756290069),
(332, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756370338),
(333, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756443784),
(334, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756446462),
(335, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756452157),
(336, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756453997),
(337, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756458146),
(338, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756458857),
(339, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756464557),
(340, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756480883),
(341, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756481019),
(342, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756481415),
(343, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756484717),
(344, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756485247),
(345, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756490558),
(346, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756490609),
(347, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756490615),
(348, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756490615),
(349, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756490616),
(350, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756492374),
(351, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756492374),
(352, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756492375),
(353, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756552994),
(354, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756575453),
(355, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756576749),
(356, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756576750),
(357, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756577670),
(358, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756578038),
(359, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756667138),
(360, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756667482),
(361, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756667707),
(362, 'vi', 'themes', 'Thiết lập layout theme: \"default\"', '', '', 1, 1756668328),
(363, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756716789),
(364, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756717507),
(365, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756717518),
(366, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756717582),
(367, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756717599),
(368, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756717663),
(369, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1756721908),
(370, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756746358),
(371, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1756746381),
(372, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756748179),
(373, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756748397),
(374, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1756749860),
(375, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756753207),
(376, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756753207),
(377, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756753207),
(378, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756795422),
(379, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756795876),
(380, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756795876),
(381, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756795877),
(382, 'vi', 'themes', 'Thiết lập layout theme: \"default\"', '', '', 1, 1756796280),
(383, 'vi', 'themes', 'Thêm block', 'Name : Các chuyên mục chính', '', 1, 1756797232),
(384, 'vi', 'themes', 'Sửa block', 'Name : Sản phẩm', '', 1, 1756797248),
(385, 'vi', 'themes', 'Sửa block', 'Name : Công ty chủ quản', '', 1, 1756797256),
(386, 'vi', 'themes', 'Sửa block', 'Name : Các chuyên mục chính', '', 1, 1756797273),
(387, 'vi', 'themes', 'Sửa block', 'Name : QR code', '', 1, 1756797282),
(388, 'vi', 'themes', 'Sửa block', 'Name : Online button', '', 1, 1756797290),
(389, 'vi', 'themes', 'Sửa block', 'Name : Copyright', '', 1, 1756797297),
(390, 'vi', 'themes', 'Sửa block', 'Name : Feedback', '', 1, 1756797304),
(391, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756802690),
(392, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756802696),
(393, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756802697),
(394, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756802697),
(395, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756890604),
(396, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1756890653),
(397, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1756894064),
(398, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1756894080),
(399, 'vi', 'login', '[webmaster] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1756894099),
(400, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756894653),
(401, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756894653),
(402, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756894653),
(403, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1756894653),
(404, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1756896394),
(405, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1756900828),
(406, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1756915546),
(407, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1756916829),
(408, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1756920858),
(409, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1756997267),
(410, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757001697),
(411, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1757002283),
(412, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1757002461),
(413, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757002636),
(414, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757002637),
(415, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757002660),
(416, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1757004557),
(417, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1757006417),
(418, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757067429),
(419, 'vi', 'sharecode', 'add_multi_tags', 'dsadsa; dasdasdsadsadsada; dsadsadsddddddddd; dsada23131', '', 1, 1757069501),
(420, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1757072764),
(421, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757088132),
(422, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1757089565),
(423, 'vi', 'users', 'log_add_user', 'userid 3', '', 1, 1757089713),
(424, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 2, 1757089724),
(425, 'vi', 'users', '[huydepzai2] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1757089733),
(426, 'vi', 'users', '[huydepzai2] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 3, 1757094257),
(427, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1757094272),
(428, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757177561),
(429, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757180259),
(430, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757180260),
(431, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757180260),
(432, 'vi', 'users', '[huydepzai2] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1757181406),
(433, 'vi', 'sharecode', 'Approve Product', 'ID: 6 - Test 1 - Note: dsadsadas', '', 1, 1757181485),
(434, 'vi', 'sharecode', 'Approve Product', 'ID: 4 - test website 3 - Note: Sản phẩm đã được phê duyệt', '', 1, 1757182729),
(435, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757184132),
(436, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757184133),
(437, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757184133),
(438, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757184172),
(439, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757232014),
(440, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757232043),
(441, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1757232044),
(442, 'vi', 'themes', 'Xóa các thiết lập', 'theme sharecode', '', 1, 1757232483),
(443, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1757233672),
(444, 'vi', 'modules', 'Cài lại module \"sharecode\"', '', '', 1, 1757233730),
(445, 'vi', 'sharecode', 'Approve Product', 'ID: 2 - dsadsadsada - Note: dsad', '', 1, 1757234115),
(446, 'vi', 'settings', 'Change System setting', '', '', 1, 1757234319),
(447, 'vi', 'settings', 'Change System setting', '', '', 1, 1757234440),
(448, 'vi', 'settings', 'Change System setting', '', '', 1, 1757236427),
(449, 'vi', 'settings', 'Change System setting', '', '', 1, 1757236491),
(450, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757241568),
(451, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1757244975),
(452, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757252941),
(453, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757586187),
(454, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1757655319),
(455, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1757657168),
(456, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1758046128),
(457, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758046140),
(458, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1758477283),
(459, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1758959929),
(460, 'vi', 'themes', 'Thêm block', 'Name : global bootstrap', '', 1, 1758960024),
(461, 'vi', 'menu', 'Add row menu', 'Row menu id: 24 of Menu id: 1', '', 1, 1758960934),
(462, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758961892),
(463, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758961893),
(464, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758961941),
(465, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758961941),
(466, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758961942),
(467, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758961942),
(468, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962000),
(469, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962035),
(470, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962035),
(471, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962036),
(472, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962076),
(473, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962076),
(474, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962076),
(475, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962077),
(476, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962077),
(477, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962151),
(478, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962151),
(479, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962182),
(480, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962182),
(481, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962311),
(482, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962311),
(483, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962350),
(484, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962434),
(485, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962434),
(486, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962457),
(487, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962457),
(488, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962458),
(489, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962493),
(490, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962494),
(491, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962550),
(492, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962550),
(493, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962572);
INSERT INTO `nv4_logs` (`id`, `lang`, `module_name`, `name_key`, `note_action`, `link_acess`, `userid`, `log_time`) VALUES
(494, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962572),
(495, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962663),
(496, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962663),
(497, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962678),
(498, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962678),
(499, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962679),
(500, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962775),
(501, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962775),
(502, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962792),
(503, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962808),
(504, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962808),
(505, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962808),
(506, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962870),
(507, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962870),
(508, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962871),
(509, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962976),
(510, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962976),
(511, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962999),
(512, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758962999),
(513, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963000),
(514, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963000),
(515, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963001),
(516, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963001),
(517, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963002),
(518, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963002),
(519, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963088),
(520, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963088),
(521, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963126),
(522, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963159),
(523, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963159),
(524, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963159),
(525, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963221),
(526, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963222),
(527, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963222),
(528, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963222),
(529, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963223),
(530, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963223),
(531, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963224),
(532, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963224),
(533, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963224),
(534, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963225),
(535, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963225),
(536, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963243),
(537, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963243),
(538, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963243),
(539, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963243),
(540, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963244),
(541, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963273),
(542, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963365),
(543, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963366),
(544, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963366),
(545, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963367),
(546, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963367),
(547, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963386),
(548, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963387),
(549, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963483),
(550, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963483),
(551, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963507),
(552, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963508),
(553, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963706),
(554, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963709),
(555, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758963709),
(556, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758964313),
(557, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1758967238),
(558, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758969842),
(559, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758969843),
(560, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758969843),
(561, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758969874),
(562, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970026),
(563, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970026),
(564, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970026),
(565, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970027),
(566, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970240),
(567, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970241),
(568, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970241),
(569, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970458),
(570, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970458),
(571, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970548),
(572, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970628),
(573, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758970628),
(574, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1758986506),
(575, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758986512),
(576, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758986514),
(577, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758987022),
(578, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1758991659),
(579, 'vi', 'themes', 'Thiết lập giao diện theme: \"sharecode-bs5\"', '', '', 1, 1758991677),
(580, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758992167),
(581, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758992218),
(582, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758992220),
(583, 'vi', 'themes', 'Kích hoạt theme: \"sharecode-bs5\"', '', '', 1, 1758992232),
(584, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758992641),
(585, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758992889),
(586, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758992889),
(587, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993156),
(588, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993157),
(589, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993418),
(590, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993419),
(591, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993468),
(592, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993468),
(593, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993524),
(594, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993524),
(595, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993524),
(596, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993594),
(597, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758993623),
(598, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758994294),
(599, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758994431),
(600, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758994431),
(601, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758996037),
(602, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758996615),
(603, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758996640),
(604, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758996942),
(605, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997332),
(606, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997424),
(607, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997424),
(608, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997424),
(609, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997464),
(610, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997464),
(611, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997595),
(612, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997646),
(613, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997647),
(614, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997678),
(615, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997678),
(616, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997678),
(617, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997716),
(618, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997717),
(619, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997905),
(620, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997905),
(621, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997905),
(622, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758997931),
(623, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998135),
(624, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998142),
(625, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998185),
(626, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998185),
(627, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998284),
(628, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998284),
(629, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998366),
(630, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998404),
(631, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998430),
(632, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998463),
(633, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998463),
(634, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998464),
(635, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998464),
(636, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998514),
(637, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998514),
(638, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998558),
(639, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998558),
(640, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998641),
(641, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998641),
(642, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998642),
(643, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998679),
(644, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998679),
(645, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998679),
(646, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998680),
(647, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998680),
(648, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998838),
(649, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998839),
(650, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998839),
(651, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758998873),
(652, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999060),
(653, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999060),
(654, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999126),
(655, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999126),
(656, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999412),
(657, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999412),
(658, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999413),
(659, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999442),
(660, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999443),
(661, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999677),
(662, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999705),
(663, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999706),
(664, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1758999867),
(665, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1759032514),
(666, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759034464),
(667, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759034464),
(668, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759034464),
(669, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759034689),
(670, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759034976),
(671, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759034977),
(672, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759035859),
(673, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759035860),
(674, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759038114),
(675, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759038115),
(676, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039327),
(677, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039328),
(678, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039396),
(679, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039396),
(680, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039433),
(681, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039433),
(682, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039462),
(683, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039462),
(684, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039497),
(685, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039498),
(686, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039498),
(687, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039540),
(688, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039571),
(689, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039572),
(690, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039594),
(691, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039595),
(692, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039826),
(693, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759039826),
(694, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759040968),
(695, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759040969),
(696, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759042318),
(697, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759042318),
(698, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759042848),
(699, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759042848),
(700, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1759043358),
(701, 'vi', 'themes', 'Kích hoạt theme: \"default\"', '', '', 1, 1759046838),
(702, 'vi', 'themes', 'Kích hoạt theme: \"sharecode-bs5\"', '', '', 1, 1759046876),
(703, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047184),
(704, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047185),
(705, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047185),
(706, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047185),
(707, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047186),
(708, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047186),
(709, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047186),
(710, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047187),
(711, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047187),
(712, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047201),
(713, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047201),
(714, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047202),
(715, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1759047215),
(716, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047270),
(717, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047271),
(718, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047271),
(719, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047744),
(720, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047744),
(721, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047744),
(722, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047745),
(723, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047748),
(724, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047748),
(725, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047750),
(726, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047751),
(727, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759047849),
(728, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 2, 1759049255),
(729, 'vi', 'themes', 'Kích hoạt theme: \"default\"', '', '', 1, 1759049563),
(730, 'vi', 'themes', 'Thêm block', 'Name : block.user_button', '', 1, 1759049591),
(731, 'vi', 'themes', 'Thêm block', 'Name : global user button', '', 1, 1759049658),
(732, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050102),
(733, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050105),
(734, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050105),
(735, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050106),
(736, 'vi', 'themes', 'Kích hoạt theme: \"sharecode-bs5\"', '', '', 1, 1759050128),
(737, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050548),
(738, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050548),
(739, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050549),
(740, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050549),
(741, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050549),
(742, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050550),
(743, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050550),
(744, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759050550),
(745, 'vi', 'themes', 'Sửa block', 'Name : Menu Site', '', 1, 1759050607),
(746, 'vi', 'themes', 'Thêm block', 'Name : global bootstrap', '', 1, 1759050634),
(747, 'vi', 'themes', 'Thêm block', 'Name : global user button', '', 1, 1759051332),
(748, 'vi', 'themes', 'Sửa block', 'Name : global bootstrap', '', 1, 1759051846),
(749, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1759052527),
(750, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759052774),
(751, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759052774),
(752, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759052775),
(753, 'vi', 'themes', 'Thêm block', 'Name : global block search', '', 1, 1759053642),
(754, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1759054387),
(755, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1759055442),
(756, 'vi', 'upload', 'Upload file', 'uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-5.jpg', '', 1, 1759060412),
(757, 'vi', 'upload', 'Upload file', 'uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-4.jpg', '', 1, 1759060413),
(758, 'vi', 'upload', 'Upload file', 'uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-3.jpg', '', 1, 1759060413),
(759, 'vi', 'upload', 'Upload file', 'uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-2.jpg', '', 1, 1759060413),
(760, 'vi', 'upload', 'Upload file', 'uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg', '', 1, 1759060414),
(761, 'vi', 'upload', 'Upload file', 'uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', 1, 1759060414),
(762, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1759062582),
(763, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1759064975),
(764, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759065495),
(765, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759065495),
(766, 'vi', 'users', '[huydepzai121] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1759067283),
(767, 'vi', 'users', '[huydepzai121] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1759069565),
(768, 'vi', 'users', '[admin] Đăng nhập theo kiểu thông thường', ' Client IP:127.0.0.1', '', 0, 1759079233),
(769, 'vi', 'users', '[admin] Thoát khỏi tài khoản người dùng', ' Client IP:127.0.0.1', '', 0, 1759081062),
(770, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1759149624),
(771, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149632),
(772, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149633),
(773, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149828),
(774, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149828),
(775, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149829),
(776, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149829),
(777, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149998),
(778, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149998),
(779, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1759149999),
(780, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1759629895);
...
(0, 'module', 'about', 0, 0, 'page', 'about', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(19, 'module', 'banners', 1, 0, 'banners', 'banners', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(281, 'module', 'comment', 1, 0, 'comment', 'comment', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(20, 'module', 'contact', 0, 1, 'contact', 'contact', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(0, 'module', 'home', 1, 0, 'home', 'home', '4.0.00 1486025339', 1753115014, 'VINADES.,JSC (contact@vinades.vn)', ''),
(22, 'module', 'inform', 1, 0, 'inform', 'inform', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(29, 'module', 'menu', 0, 0, 'menu', 'menu', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(22, 'module', 'myapi', 1, 0, 'myapi', 'myapi', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(1, 'module', 'news', 0, 1, 'news', 'news', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(282, 'module', 'page', 1, 1, 'page', 'page', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(284, 'module', 'seek', 1, 0, 'seek', 'seek', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(0, 'module', 'sharecode', 0, 1, 'sharecode', 'sharecode', '2.0.00 1737176400', 1752944507, 'VINADES.,JSC <contact@vinades.vn>', 'Module marketplace chia sẻ mã nguồn với hệ thống thanh toán và giỏ hàng'),
(0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(24, 'module', 'users', 1, 1, 'users', 'users', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(21, 'module', 'voting', 0, 0, 'voting', 'voting', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(0, 'module', 'wallet', 1, 1, 'wallet', 'wallet', '4.5.02 1664006400', 1753115014, 'VINADES (contact@vinades.vn)', 'Quản lý tiền thành viên'),
(517, 'module', 'zalo', 1, 0, 'zalo', 'zalo', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(307, 'theme', 'default', 0, 0, 'default', 'default', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', ''),
(311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '5.0.00 1736144674', 1752944348, 'VINADES.,JSC <contact@vinades.vn>', '');
...
(0, '', 0, 0, 3, 300, 300, 90),
(1, 'uploads', 1752944454, 1413366, 0, 0, 0, 0),
(2, 'uploads/about', 1752944454, 242102, 0, 0, 0, 0),
(3, 'uploads/banners', 1752944454, 179287, 0, 0, 0, 0),
(4, 'uploads/banners/files', 1752944454, 0, 0, 0, 0, 0),
(5, 'uploads/comment', 1752944454, 0, 0, 0, 0, 0),
(6, 'uploads/contact', 1752944454, 0, 0, 0, 0, 0),
(7, 'uploads/emailtemplates', 1752944454, 0, 0, 0, 0, 0),
(8, 'uploads/feeds', 1752944454, 0, 0, 0, 0, 0),
(9, 'uploads/freecontent', 1752944454, 138096, 0, 0, 0, 0),
(10, 'uploads/inform', 1752944454, 0, 0, 0, 0, 0),
(11, 'uploads/menu', 1752944454, 0, 0, 0, 0, 0),
(12, 'uploads/news', 1752944454, 853881, 0, 0, 0, 0),
(13, 'uploads/news/authors', 1752944454, 0, 0, 0, 0, 0),
(14, 'uploads/news/source', 1752944454, 0, 0, 0, 0, 0),
(15, 'uploads/news/temp_pic', 1752944454, 0, 0, 0, 0, 0),
(16, 'uploads/news/topics', 1752944454, 0, 0, 0, 0, 0),
(17, 'uploads/page', 1752944454, 0, 0, 0, 0, 0),
(18, 'uploads/sharecode', 1752944454, 0, 0, 0, 0, 0),
(19, 'uploads/sharecode/files', 1752944454, 0, 0, 0, 0, 0),
(20, 'uploads/sharecode/images', 1752944454, 0, 0, 0, 0, 0),
(21, 'uploads/sharecode/sources', 1752944454, 0, 0, 0, 0, 0),
(22, 'uploads/sharecode/thumbnails', 1752944454, 0, 0, 0, 0, 0),
(23, 'uploads/siteterms', 1752944454, 0, 0, 0, 0, 0),
(24, 'uploads/users', 1752944454, 0, 0, 0, 0, 0),
(25, 'uploads/users/groups', 1752944454, 0, 0, 0, 0, 0),
(26, 'uploads/users/userfiles', 1752944454, 0, 0, 0, 0, 0),
(27, 'uploads/wallet', 1752944454, 0, 0, 0, 0, 0),
(28, 'uploads/wallet/wellet', 1752944454, 0, 0, 0, 0, 0),
(29, 'uploads/zalo', 1752944454, 0, 0, 0, 0, 0),
(30, 'uploads/home', 0, 0, 0, 0, 0, 0),
(31, 'uploads/news/2025_08', 0, 0, 0, 0, 0, 0),
(32, 'uploads/sharecode/2025_08', 0, 0, 0, 0, 0, 0),
(33, 'uploads/sharecode/2025_09', 0, 0, 0, 0, 0, 0);
...
('logo-nukev...png', 'png', 'image', 13223, 'assets/about/logo-nukeviet3-flag-180x75.png', 80, 33, '180|75', 1, 1752828877, 2, 'logo-nukeviet3-flag-180x75.png', 'logo nukeviet3 flag 180x75'),
('nukevietcm...png', 'png', 'image', 13125, 'assets/about/nukevietcms_laco_180x57.png', 80, 25, '180|57', 1, 1752828877, 2, 'nukevietcms_laco_180x57.png', 'nukevietcms laco 180x57'),
('nukevietcm...png', 'png', 'image', 13319, 'assets/about/nukevietcms_mu_noel_180x84.png', 80, 37, '180|84', 1, 1752828877, 2, 'nukevietcms_mu_noel_180x84.png', 'nukevietcms mu noel 180x84'),
('nukevietcm...png', 'png', 'image', 11974, 'assets/about/nukevietcms-180x84.png', 80, 37, '180|84', 1, 1752828877, 2, 'nukevietcms-180x84.png', 'nukevietcms 180x84'),
('nukevietcms.png', 'png', 'image', 85684, 'assets/about/nukevietcms.png', 80, 37, '1500|700', 1, 1752828877, 2, 'nukevietcms.png', 'nukevietcms'),
('nukevietvn...png', 'png', 'image', 11586, 'assets/about/nukevietvn_180x84.png', 80, 37, '180|84', 1, 1752828877, 2, 'nukevietvn_180x84.png', 'nukevietvn 180x84'),
('nukevietvn.png', 'png', 'image', 81035, 'assets/about/nukevietvn.png', 80, 37, '1500|700', 1, 1752828877, 2, 'nukevietvn.png', 'nukevietvn'),
('w.png', 'png', 'image', 12156, 'assets/about/w.png', 80, 40, '288|143', 1, 1752828877, 2, 'w.png', 'w'),
('vinades.jpg', 'jpg', 'image', 104940, 'assets/banners/vinades.jpg', 42, 80, '212|400', 1, 1752828877, 3, 'vinades.jpg', 'vinades'),
('webnhanh.jpg', 'jpg', 'image', 74347, 'assets/banners/webnhanh.jpg', 80, 10, '572|72', 1, 1752828877, 3, 'webnhanh.jpg', 'webnhanh'),
('cms.jpg', 'jpg', 'image', 29026, 'assets/freecontent/cms.jpg', 80, 44, '130|71', 1, 1752828877, 9, 'cms.jpg', 'cms'),
('edugate.jpg', 'jpg', 'image', 28008, 'assets/freecontent/edugate.jpg', 80, 44, '130|71', 1, 1752828877, 9, 'edugate.jpg', 'edugate'),
('portal.jpg', 'jpg', 'image', 25973, 'assets/freecontent/portal.jpg', 80, 44, '130|71', 1, 1752828877, 9, 'portal.jpg', 'portal'),
('shop.jpg', 'jpg', 'image', 26352, 'assets/freecontent/shop.jpg', 80, 44, '130|71', 1, 1752828877, 9, 'shop.jpg', 'shop'),
('toa-soan-d...jpg', 'jpg', 'image', 28737, 'assets/freecontent/toa-soan-dien-tu.jpg', 80, 44, '130|71', 1, 1752828877, 9, 'toa-soan-dien-tu.jpg', 'toa soan dien tu'),
('chuc-mung-...jpg', 'jpg', 'image', 130708, 'assets/news/chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg', 80, 63, '461|360', 1, 1752828877, 12, 'chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg', 'chuc mung nukeviet thong tu 20 bo tttt'),
('hoc-viec-t...jpg', 'jpg', 'image', 167193, 'assets/news/hoc-viec-tai-cong-ty-vinades.jpg', 80, 63, '460|360', 1, 1752828877, 12, 'hoc-viec-tai-cong-ty-vinades.jpg', 'hoc viec tai cong ty vinades'),
('hoptac.jpg', 'jpg', 'image', 12871, 'assets/news/hoptac.jpg', 80, 66, '382|314', 1, 1752828877, 12, 'hoptac.jpg', 'hoptac'),
('nangly.jpg', 'jpg', 'image', 34802, 'assets/news/nangly.jpg', 80, 53, '500|332', 1, 1752828877, 12, 'nangly.jpg', 'nangly'),
('nukeviet-cms.jpg', 'jpg', 'image', 83489, 'assets/news/nukeviet-cms.jpg', 80, 55, '500|345', 1, 1752828877, 12, 'nukeviet-cms.jpg', 'nukeviet cms'),
('nukeviet-n...jpg', 'jpg', 'image', 18611, 'assets/news/nukeviet-nhantaidatviet2011.jpg', 80, 54, '400|268', 1, 1752828877, 12, 'nukeviet-nhantaidatviet2011.jpg', 'nukeviet nhantaidatviet2011'),
('tap-huan-p...jpg', 'jpg', 'image', 132379, 'assets/news/tap-huan-pgd-ha-dong-2015.jpg', 80, 51, '460|295', 1, 1752828877, 12, 'tap-huan-pgd-ha-dong-2015.jpg', 'tap huan pgd ha dong 2015'),
('thuc-tap-sinh.jpg', 'jpg', 'image', 71135, 'assets/news/thuc-tap-sinh.jpg', 80, 63, '460|360', 1, 1752828877, 12, 'thuc-tap-sinh.jpg', 'thuc tap sinh'),
('tuyen-dung...png', 'png', 'image', 118910, 'assets/news/tuyen-dung-nvkd.png', 80, 56, '400|279', 1, 1752828877, 12, 'tuyen-dung-nvkd.png', 'tuyen dung nvkd'),
('tuyendung-...jpg', 'jpg', 'image', 83783, 'assets/news/tuyendung-kythuat.jpg', 80, 80, '300|300', 1, 1752828877, 12, 'tuyendung-kythuat.jpg', 'tuyendung kythuat'),
('499478119_...jpg', 'jpg', 'image', 114436, 'assets/sharecode/499478119_2106000256583165_7079072595933555695_n.jpg', 80, 52, '1375|893', 1, 1755885034, 18, '499478119_2106000256583165_7079072595933555695_n.jpg', '499478119 2106000256583165 7079072595933555695 n'),
('code-do-an...jpg', 'jpg', 'image', 153322, 'assets/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg', 20, 80, '378|1500', 1, 1759060414, 18, 'code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg', 'code do an code php mysql website ban sach full code mvc database 22437 &#40;1&#41;'),
('code-do-an...jpg', 'jpg', 'image', 153322, 'assets/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-2.jpg', 20, 80, '378|1500', 1, 1759060414, 18, 'code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-2.jpg', 'code do an code php mysql website ban sach full code mvc database 22437 &#40;2&#41;'),
('code-do-an...jpg', 'jpg', 'image', 153322, 'assets/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-3.jpg', 20, 80, '378|1500', 1, 1759060413, 18, 'code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-3.jpg', 'code do an code php mysql website ban sach full code mvc database 22437 &#40;3&#41;'),
('code-do-an...jpg', 'jpg', 'image', 153322, 'assets/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-4.jpg', 20, 80, '378|1500', 1, 1759060413, 18, 'code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-4.jpg', 'code do an code php mysql website ban sach full code mvc database 22437 &#40;4&#41;'),
('code-do-an...jpg', 'jpg', 'image', 153322, 'assets/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-5.jpg', 20, 80, '378|1500', 1, 1759060413, 18, 'code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-5.jpg', 'code do an code php mysql website ban sach full code mvc database 22437 &#40;5&#41;'),
('code-do-an...jpg', 'jpg', 'image', 150872, 'assets/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', 80, 60, '500|375', 1, 1759060414, 18, 'code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', 'code do an code php mysql website ban sach full code mvc database 22437'),
('top-code.jpg', 'jpg', 'image', 92762, 'assets/sharecode/top-code.jpg', 80, 33, '857|350', 1, 1754756065, 18, 'top-code.jpg', 'top code'),
...
CREATE TABLE `nv4_users` (
  ...
  `url_config` varchar(255) DEFAULT '',
...
INSERT INTO `nv4_users` (`userid`, `group_id`, `username`, `md5username`, `password`, `email`, `url_config`, `first_name`, `last_name`, `gender`, `photo`, `birthday`, `sig`, `regdate`, `question`, `answer`, `passlostkey`, `view_mail`, `remember`, `in_groups`, `active`, `active2step`, `secretkey`, `pref_2fa`, `sec_keys`, `checknum`, `last_login`, `last_ip`, `last_agent`, `last_openid`, `last_passkey`, `last_update`, `idsite`, `safemode`, `safekey`, `pass_creation_time`, `pass_reset_request`, `email_creation_time`, `email_reset_request`, `email_verification_time`, `active_obj`, `language`) VALUES
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}H0Z96LuzH4Iv4hg56c9RFHGg0oWLLVkxKgf5AzmtpLdSweGD/FYktMNlXg9a3lIDcdFhUV3G1hMsmC4Aqw9+EmQ5Mzk=', 'nguyenthehuy977943@gmail.com', '', 'admin', '', '', '', 0, '', 1752944454, '231', '2131', '', 0, 1, '1,4', 1, 0, '', 0, 0, '80043d9baf2da367d06da1d74e5649a5', 1759079233, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '', '', 0, 0, 0, '', 1752944454, 0, 1752944454, 0, -3, 'SYSTEM', ''),
(2, 4, 'huydepzai121', '480d6f6837bbe11733ec1b1659afa68e', '{SSHA512}7ogsmfgzF5FbeAT4RfAbTYyOX3lYFiJ0j1iYGi2m+FU/gdZxRSwpq6aWXJhaCM+5TNWewjHH+KtRi9Z0lDGbJjQ3Y2I=', '', '', 'Hải', 'Nguyễn', 'M', '', 678474000, '', 1753021239, '213', '321321', '', 0, 1, '4', 1, 0, '', 0, 0, 'adfa3fd294359d47600e61ae08f6ad86', 1759067283, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '', '', 0, 0, 0, '', 1753021239, 0, 1753021239, 0, -1, 'SYSTEM', ''),
(3, 4, 'huydepzai2', '2f3fa8a1b13b7e8925aa9511b43ea730', '{SSHA512}EXHXwgABcAelUYtr8001+6bQIuj23rmcpF3NUd/VyJkmVvxKbIpmKKm/6tpa9GYPppXz4gJ1geq2OnJwfWFWzDBjYjQ=', 'nguyenthehuy97794sdad3@gmail.com', '', 'Huy 1', 'Nguyễn Thế', 'M', '', 937328400, 'sda', 1757089713, 'dsadsa', 'dsadsa', '', 0, 1, '4', 1, 0, '', 0, 0, '5392305d5d64c7fa235abc2698827596', 1757181406, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '', '', 0, 0, 0, '', 1757089713, 0, 1757089713, 0, -1, 'SYSTEM', '');
...
(1, 'Super-Admin', '', 0, '', '', 0, 0, 0, 1752944348, 0, 1, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(2, 'General-Admin', '', 0, '', '', 0, 0, 0, 1752944348, 0, 2, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(3, 'Module-Admin', '', 0, '', '', 0, 0, 0, 1752944348, 0, 3, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(4, 'Users', '', 0, '', '', 0, 0, 0, 1752944348, 0, 4, 1, 0, 3, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(7, 'New-Users', '', 0, '', '', 0, 0, 0, 1752944348, 0, 5, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(5, 'Guest', '', 0, '', '', 0, 0, 0, 1752944348, 0, 6, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(6, 'All', '', 0, '', '', 0, 0, 0, 1752944348, 0, 7, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(10, 'NukeViet-Fans', '', 2, '', '', 0, 0, 1, 1752944348, 0, 8, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(11, 'NukeViet-Admins', '', 2, '', '', 0, 0, 0, 1752944348, 0, 9, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(12, 'NukeViet-Programmers', '', 1, '', '', 0, 0, 0, 1752944348, 0, 10, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}');
...
(1, 1, 1, 1, '0', 1752944454, 1752944454);
...
INSERT INTO `nv4_users_info` (`userid`, `inform`) VALUES
(1, '0|1758999253'),
(2, '0|1755919807'),
(3, '');
...
--
-- Đang đổ dữ liệu cho bảng `nv4_users_login`
--

INSERT INTO `nv4_users_login` (`userid`, `clid`, `logtime`, `mode`, `agent`, `ip`, `mode_extra`) VALUES
(3, 'b44c8a45e921655aef2f5244047a42d3', 1757181406, 0, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '127.0.0.1', '');
...
--
-- Cấu trúc bảng cho bảng `nv4_users_passkey`
--

DROP TABLE IF EXISTS `nv4_users_passkey`;
CREATE TABLE `nv4_users_passkey` (
  `id` int(11) UNSIGNED NOT NULL,
  `userid` mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
...
INSERT INTO `nv4_vi_blocks_groups` (`bid`, `theme`, `module`, `file_name`, `title`, `link`, `template`, `heading`, `position`, `dtime_type`, `dtime_details`, `active`, `act`, `groups_view`, `all_func`, `weight`, `config`) VALUES
...
(12, 'default', 'contact', 'global.contact_form.php', 'Feedback', '', 'no_title', 0, '[FOOTER_SITE]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
(16, 'default', 'users', 'global.user_button.php', 'Đăng nhập người dùng', '', 'no_title', 0, '[PERSONALAREA]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
...
(35, 'default', 'sharecode', 'global.block_search.php', 'global block search', '', 'no_title', 0, '[HEADER]', 'regular', '[]', '1', 1, '6', 0, 1, 'a:2:{s:20:\"show_category_filter\";i:1;s:17:\"show_price_filter\";i:1;}'),
(62, 'default', 'menu', 'global.bootstrap.php', 'global bootstrap', '', 'no_title', 0, '[MENU_SITE]', 'regular', '[]', '1', 1, '6', 1, 1, 'a:2:{s:6:\"menuid\";i:1;s:12:\"title_length\";i:0;}'),
(64, 'sharecode-bs5', 'contact', 'global.contact_default.php', 'Contact Default', '', 'no_title', 0, '[CONTACT_DEFAULT]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
(67, 'sharecode-bs5', 'contact', 'global.contact_form.php', 'Feedback', '', 'no_title', 0, '[FOOTER_SITE]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
(68, 'sharecode-bs5', 'news', 'global.block_category.php', 'Chủ đề', '', 'no_title', 0, '[LEFT]', 'regular', '[]', '1', 1, '6', 0, 1, 'a:2:{s:5:\"catid\";i:0;s:12:\"title_length\";i:0;}'),
(69, 'sharecode-bs5', 'theme', 'global.module_menu.php', 'Module Menu', '', 'no_title', 0, '[LEFT]', 'regular', '[]', '1', 0, '6', 0, 2, ''),
(74, 'sharecode-bs5', 'inform', 'global.inform.php', 'Thông báo', '', 'no_title', 0, '[PERSONALAREA]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
(75, 'sharecode-bs5', 'users', 'global.user_button.php', 'Đăng nhập người dùng', '', 'no_title', 0, '[PERSONALAREA]', 'regular', '[]', '1', 0, '6', 1, 2, ''),
(79, 'sharecode-bs5', 'banners', 'global.banners.php', 'Quảng cáo cột phải', '', 'no_title', 0, '[RIGHT]', 'regular', '[]', '1', 1, '6', 1, 1, 'a:1:{s:12:\"idplanbanner\";i:3;}'),
(82, 'sharecode-bs5', 'theme', 'global.social.php', 'Social icon', '', 'no_title', 0, '[SOCIAL_ICONS]', 'regular', '[]', '1', 1, '6', 1, 1, 'a:4:{s:8:\"facebook\";s:32:\"http://www.facebook.com/nukeviet\";s:11:\"google_plus\";s:32:\"https://www.google.com/+nukeviet\";s:7:\"youtube\";s:37:\"https://www.youtube.com/user/nukeviet\";s:7:\"twitter\";s:28:\"https://twitter.com/nukeviet\";}'),
(83, 'sharecode-bs5', 'news', 'module.block_newscenter.php', 'Tin mới nhất', '', 'no_title', 0, '[TOP]', 'regular', '[]', '1', 1, '6', 0, 1, 'a:10:{s:6:\"numrow\";i:6;s:11:\"showtooltip\";i:1;s:16:\"tooltip_position\";s:6:\"bottom\";s:14:\"tooltip_length\";s:3:\"150\";s:12:\"length_title\";i:0;s:15:\"length_hometext\";i:0;s:17:\"length_othertitle\";i:60;s:5:\"width\";i:500;s:6:\"height\";i:0;s:7:\"nocatid\";a:0:{}}'),
(84, 'sharecode-bs5', 'banners', 'global.banners.php', 'Quảng cáo giữa trang', '', 'no_title', 0, '[TOP]', 'regular', '[]', '1', 1, '6', 0, 2, 'a:1:{s:12:\"idplanbanner\";i:1;}'),
(85, 'default', 'users', 'global.user_button.php', 'block.user_button', 'block.user_button', 'no_title', 0, '[FIX_BANNER_RIGHT]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
(86, 'default', 'users', 'global.user_button.php', 'global user button', '', 'no_title', 0, '[TOP]', 'regular', '[]', '1', 1, '6', 1, 3, ''),
(87, 'sharecode-bs5', 'menu', 'global.menusharecode.php', 'global bootstrap', '', 'no_title', 0, '[MENU_SITE]', 'regular', '[]', '1', 1, '6', 1, 1, 'a:2:{s:6:\"menuid\";i:1;s:12:\"title_length\";i:0;}'),
(88, 'sharecode-bs5', 'users', 'global.user_button.php', 'global user button', '', 'no_title', 0, '[PERSONALAREA123]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
(89, 'sharecode-bs5', 'sharecode', 'global.block_search.php', 'global block search', '', 'no_title', 0, '[TOP]', 'regular', '[]', '1', 1, '6', 0, 3, 'a:2:{s:20:\"show_category_filter\";i:1;s:17:\"show_price_filter\";i:1;}');
...
CREATE TABLE `nv4_vi_log_message` (
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `url_config` varchar(500) NOT NULL DEFAULT ''
...
(3, 0, 1, 'Tài khoản người dùng', '/index.php?language=vi&nv=users', '', '', '', 3, 19, 0, '', '6', 'users', '', 1, '', 1, 1),
(4, 0, 1, 'Thống kê', '/index.php?language=vi&nv=statistics', '', '', '', 4, 20, 0, '', '2', 'statistics', '', 1, '', 1, 1),
(5, 0, 1, 'Thăm dò ý kiến', '/index.php?language=vi&nv=voting', '', '', '', 5, 21, 0, '', '6', 'voting', '', 1, '', 1, 1),
(6, 0, 1, 'Tìm kiếm', '/index.php?language=vi&nv=seek', '', '', '', 6, 22, 0, '', '6', 'seek', '', 1, '', 1, 1),
(7, 0, 1, 'Liên hệ', '/index.php?language=vi&nv=contact', '', '', '', 7, 23, 0, '', '6', 'contact', '', 1, '', 1, 1),
...
(19, 2, 1, 'Quản lý bài viết', '/index.php?language=vi&nv=news&op=content', '', '', '', 4, 14, 1, '24', '6', 'news', 'content', 1, '', 1, 1),
(20, 2, 1, 'Tìm kiếm', '/index.php?language=vi&nv=news&op=search', '', '', '', 5, 16, 1, '', '6', 'news', 'search', 1, '', 1, 1),
(21, 2, 1, 'Tin tức', '/index.php?language=vi&nv=news&op=Tin-tuc', '', '', '', 6, 17, 1, '', '6', 'news', 'Tin-tuc', 1, '', 1, 1),
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_modblocks`
--

DROP TABLE IF EXISTS `nv4_vi_modblocks`;
...
(76, 'category', 'category', 'Category', '', '', 'sharecode', 1, 0, 2, ''),
(77, 'detail', 'detail', 'Detail', '', '', 'sharecode', 1, 1, 3, ''),
(78, 'download', 'download', 'Download', '', '', 'sharecode', 1, 0, 4, ''),
(79, 'main', 'main', 'Main', '', '', 'sharecode', 1, 0, 1, ''),
(80, 'purchase', 'purchase', 'Purchase', '', '', 'sharecode', 1, 1, 6, ''),
(82, 'tag', 'tag', 'Tag', '', '', 'sharecode', 1, 0, 5, ''),
(83, 'complete', 'complete', 'Complete', '', '', 'wallet', 1, 0, 3, ''),
(84, 'exchange', 'exchange', 'Exchange', '', '', 'wallet', 1, 1, 5, ''),
(85, 'historyexchange', 'historyexchange', 'Historyexchange', '', '', 'wallet', 1, 1, 6, ''),
(86, 'ipn', 'ipn', 'Ipn', '', '', 'wallet', 0, 0, 0, ''),
(87, 'loadinfomoney', 'loadinfomoney', 'Loadinfomoney', '', '', 'wallet', 0, 0, 0, ''),
(88, 'main', 'main', 'Main', '', '', 'wallet', 1, 1, 1, ''),
(89, 'money', 'money', 'Money', '', '', 'wallet', 1, 1, 4, ''),
(90, 'pay', 'pay', 'Pay', '', '', 'wallet', 1, 0, 2, ''),
(91, 'recharge', 'recharge', 'Recharge', '', '', 'wallet', 1, 0, 7, ''),
(92, 'history', 'history', 'History', '', '', 'sharecode', 1, 1, 7, ''),
(93, 'author', 'author', 'Author', '', '', 'sharecode', 1, 1, 9, ''),
(95, 'submit', 'submit', 'Submit', '', '', 'sharecode', 1, 1, 8, ''),
(96, 'main', 'main', 'Main', '', '', 'home', 1, 1, 1, ''),
(101, 'revenue', 'revenue', 'Revenue', '', '', 'sharecode', 1, 1, 10, ''),
(102, 'favorite_action', 'favorite_action', 'Favorite_action', '', '', 'sharecode', 1, 0, 12, ''),
(103, 'favorites', 'favorites', 'Favorites', '', '', 'sharecode', 1, 1, 11, '');
...
(0, 'left-main-right', 'sharecode-bs5'),
(0, 'main', 'mobile_default'),
(1, 'left-main-right', 'sharecode-bs5'),
(1, 'main', 'default'),
(1, 'main', 'mobile_default'),
(4, 'left-main-right', 'sharecode-bs5'),
(4, 'main', 'default'),
(4, 'main', 'mobile_default'),
(5, 'left-main-right', 'sharecode-bs5'),
(5, 'main', 'default'),
(5, 'main', 'mobile_default'),
(6, 'left-main-right', 'sharecode-bs5'),
(6, 'main', 'default'),
(6, 'main', 'mobile_default'),
(7, 'left-main-right', 'sharecode-bs5'),
(7, 'main', 'default'),
(7, 'main', 'mobile_default'),
(8, 'left-main-right', 'sharecode-bs5'),
(8, 'main', 'default'),
(8, 'main', 'mobile_default'),
(9, 'left-main-right', 'sharecode-bs5'),
(9, 'main', 'default'),
(9, 'main', 'mobile_default'),
(10, 'left-main-right', 'sharecode-bs5'),
(10, 'main', 'default'),
(11, 'left-main-right', 'sharecode-bs5'),
(11, 'main', 'default'),
(11, 'main', 'mobile_default'),
(12, 'left-main-right', 'sharecode-bs5'),
(12, 'main', 'default'),
(12, 'main', 'mobile_default'),
(13, 'left-main-right', 'sharecode-bs5'),
(13, 'main', 'default'),
(13, 'main', 'mobile_default'),
(20, 'left-main-right', 'sharecode-bs5'),
(20, 'main', 'default'),
(20, 'main', 'mobile_default'),
(21, 'left-main-right', 'sharecode-bs5'),
(21, 'main', 'default'),
(21, 'main', 'mobile_default'),
(22, 'left-main-right', 'sharecode-bs5'),
(22, 'main', 'default'),
(22, 'main', 'mobile_default'),
(23, 'left-main-right', 'sharecode-bs5'),
(23, 'main', 'default'),
(23, 'main', 'mobile_default'),
(24, 'left-main-right', 'sharecode-bs5'),
(24, 'main', 'default'),
(24, 'main', 'mobile_default'),
(25, 'left-main-right', 'sharecode-bs5'),
(25, 'main', 'default'),
(25, 'main', 'mobile_default'),
(26, 'left-main-right', 'sharecode-bs5'),
(26, 'main', 'default'),
(26, 'main', 'mobile_default'),
(27, 'left-main', 'sharecode-bs5'),
(27, 'main', 'default'),
(27, 'main', 'mobile_default'),
(28, 'left-main-right', 'sharecode-bs5'),
(28, 'main', 'default'),
(28, 'main', 'mobile_default'),
(29, 'left-main', 'sharecode-bs5'),
(29, 'main', 'default'),
(29, 'main', 'mobile_default'),
(30, 'left-main-right', 'sharecode-bs5'),
(30, 'main', 'default'),
(31, 'left-main-right', 'sharecode-bs5'),
(31, 'main', 'default'),
(31, 'main', 'mobile_default'),
(33, 'left-main-right', 'sharecode-bs5'),
(33, 'main', 'default'),
(33, 'main', 'mobile_default'),
(34, 'left-main-right', 'sharecode-bs5'),
(34, 'main', 'default'),
(34, 'main', 'mobile_default'),
(35, 'left-main', 'sharecode-bs5'),
(35, 'main', 'default'),
(35, 'main', 'mobile_default'),
(36, 'left-main', 'sharecode-bs5'),
(36, 'main', 'default'),
(36, 'main', 'mobile_default'),
(37, 'left-main', 'sharecode-bs5'),
(37, 'main', 'default'),
(37, 'main', 'mobile_default'),
(38, 'left-main', 'sharecode-bs5'),
(38, 'main', 'default'),
(38, 'main', 'mobile_default'),
(39, 'left-main', 'sharecode-bs5'),
(39, 'main', 'default'),
(39, 'main', 'mobile_default'),
(40, 'left-main', 'sharecode-bs5'),
(40, 'main', 'default'),
(40, 'main', 'mobile_default'),
(41, 'left-main', 'sharecode-bs5'),
(41, 'main', 'default'),
(41, 'main', 'mobile_default'),
(42, 'left-main', 'sharecode-bs5'),
(42, 'main', 'default'),
(42, 'main', 'mobile_default'),
(43, 'left-main', 'sharecode-bs5'),
(43, 'main', 'default'),
(43, 'main', 'mobile_default'),
(44, 'left-main-right', 'sharecode-bs5'),
(44, 'main', 'default'),
(44, 'main', 'mobile_default'),
(45, 'left-main-right', 'sharecode-bs5'),
(45, 'main', 'default'),
(45, 'main', 'mobile_default'),
(46, 'left-main-right', 'sharecode-bs5'),
(46, 'main', 'default'),
(46, 'main', 'mobile_default'),
(47, 'left-main-right', 'sharecode-bs5'),
(47, 'main', 'default'),
(47, 'main', 'mobile_default'),
(53, 'left-main-right', 'sharecode-bs5'),
(53, 'main', 'default'),
(53, 'main', 'mobile_default'),
(55, 'left-main-right', 'sharecode-bs5'),
(55, 'main', 'default'),
(55, 'main', 'mobile_default'),
(56, 'left-main', 'sharecode-bs5'),
(56, 'main', 'default'),
(56, 'main', 'mobile_default'),
(59, 'left-main-right', 'sharecode-bs5'),
(59, 'main', 'default'),
(59, 'main', 'mobile_default'),
(60, 'left-main-right', 'sharecode-bs5'),
(60, 'main', 'default'),
(60, 'main', 'mobile_default'),
(61, 'left-main-right', 'sharecode-bs5'),
(61, 'main', 'default'),
(61, 'main', 'mobile_default'),
(62, 'left-main-right', 'sharecode-bs5'),
(62, 'main', 'default'),
(62, 'main', 'mobile_default'),
(63, 'left-main-right', 'sharecode-bs5'),
(63, 'main', 'default'),
(64, 'left-main-right', 'sharecode-bs5'),
(64, 'main', 'default'),
(64, 'main', 'mobile_default'),
(65, 'left-main-right', 'sharecode-bs5'),
(65, 'main', 'default'),
(65, 'main', 'mobile_default'),
(67, 'left-main-right', 'sharecode-bs5'),
(67, 'main', 'default'),
(67, 'main', 'mobile_default'),
(68, 'left-main-right', 'sharecode-bs5'),
(68, 'main', 'default'),
(68, 'main', 'mobile_default'),
(69, 'left-main-right', 'sharecode-bs5'),
(69, 'main', 'default'),
(69, 'main', 'mobile_default'),
(76, 'left-main-right', 'sharecode-bs5'),
(76, 'main', 'default'),
(76, 'main', 'mobile_default'),
(77, 'left-main-right', 'sharecode-bs5'),
(77, 'main', 'default'),
(77, 'main', 'mobile_default'),
(78, 'left-main-right', 'sharecode-bs5'),
(78, 'main', 'default'),
(78, 'main', 'mobile_default'),
(79, 'left-main-right', 'sharecode-bs5'),
(79, 'main', 'default'),
(79, 'main', 'mobile_default'),
(80, 'left-main-right', 'sharecode-bs5'),
(80, 'main', 'default'),
(80, 'main', 'mobile_default'),
(82, 'left-main-right', 'sharecode-bs5'),
(82, 'main', 'default'),
(82, 'main', 'mobile_default'),
(83, 'left-main-right', 'sharecode-bs5'),
(83, 'main', 'default'),
(84, 'left-main-right', 'sharecode-bs5'),
(84, 'main', 'default'),
(85, 'left-main-right', 'sharecode-bs5'),
(85, 'main', 'default'),
(86, 'left-main-right', 'default'),
(87, 'left-main-right', 'default'),
(88, 'left-main-right', 'sharecode-bs5'),
(88, 'main', 'default'),
(89, 'left-main-right', 'sharecode-bs5'),
(89, 'main', 'default'),
(90, 'left-main-right', 'sharecode-bs5'),
(90, 'main', 'default'),
(91, 'left-main-right', 'sharecode-bs5'),
(91, 'main', 'default'),
(92, 'left-main-right', 'sharecode-bs5'),
(92, 'main', 'default'),
(93, 'left-main-right', 'sharecode-bs5'),
(93, 'main', 'default'),
(95, 'left-main-right', 'sharecode-bs5'),
(95, 'main', 'default'),
(96, 'left-main-right', 'sharecode-bs5'),
(96, 'main', 'default'),
(96, 'main', 'mobile_default'),
(101, 'left-main-right', 'sharecode-bs5'),
(101, 'main', 'default'),
(102, 'left-main-right', 'default'),
(102, 'left-main-right', 'sharecode-bs5'),
(103, 'left-main-right', 'sharecode-bs5'),
(103, 'main', 'default');
...
('about', 'page', 'about', 'about', 'page', 'Giới thiệu', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-campground', '6', 2, 1, '', 1, 1),
('banners', 'banners', 'banners', 'banners', 'banners', 'Quảng cáo', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-rectangle-ad', '6', 11, 1, '', 0, 1),
('comment', 'comment', 'comment', 'comment', 'comment', 'Bình luận', '', 'Quản lý bình luận', 1752944348, 0, 1, '', '', '', '', 'fa-solid fa-comments', '6', 16, 1, '', 0, 1),
('contact', 'contact', 'contact', 'contact', 'contact', 'Liên hệ', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-phone', '6', 8, 1, '', 0, 1),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-rss', '6', 14, 1, '', 0, 1),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Giới thiệu sản phẩm', '', '', 1752944348, 0, 1, '', '', '', '', 'fa-solid fa-cube', '6', 18, 1, '', 0, 1),
('home', 'home', 'home', 'home', 'home', 'Home', '', '', 1753115017, 1, 0, '', '', '', '', '', '6', 21, 1, '', 0, 0),
('inform', 'inform', 'inform', 'inform', 'inform', 'Thông báo', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-bell', '4', 7, 1, '', 0, 0),
('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', '', 1752944348, 0, 1, '', '', '', '', 'fa-solid fa-network-wired', '6', 13, 1, '', 0, 1),
('myapi', 'myapi', 'myapi', 'myapi', 'myapi', 'API của tôi', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-brands fa-nfc-symbol', '6', 6, 1, '', 0, 0),
('news', 'news', 'news', 'news', 'news', 'Tin Tức', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-newspaper', '6', 4, 1, '', 1, 1),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-file-pen', '6', 15, 1, '', 1, 0),
('seek', 'seek', 'seek', 'seek', 'seek', 'Tìm kiếm', '', '', 1752944348, 1, 0, '', '', '', '', 'fa-solid fa-magnifying-glass', '6', 12, 1, '', 0, 1),
('sharecode', 'sharecode', 'sharecode', 'sharecode', 'sharecode', 'ShareCode', '', '', 1752944607, 1, 1, '', '', '', '', '', '6', 1, 1, '', 0, 0),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Điều khoản sử dụng', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-gavel', '6', 17, 1, '', 1, 1),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Thống kê', '', '', 1752944348, 1, 1, '', '', '', 'online, statistics', 'fa-solid fa-chart-simple', '6', 9, 1, '', 0, 1),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', 'Xác thực hai bước', '', '', 1752944348, 1, 0, '', '', '', '', 'fa-solid fa-shield-halved', '6', 19, 1, '', 0, 1),
('users', 'users', 'users', 'users', 'users', 'Tài khoản người dùng', '', 'Tài khoản', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-users', '6', 5, 1, '', 0, 1),
('voting', 'voting', 'voting', 'voting', 'voting', 'Thăm dò ý kiến', '', '', 1752944348, 1, 1, '', '', '', '', 'fa-solid fa-square-poll-vertical', '6', 10, 1, '', 1, 1),
('wallet', 'wallet', 'wallet', 'wallet', 'wallet', 'Wallet', '', '', 1752944517, 1, 1, '', '', '', '', '', '6', 20, 1, '', 1, 1),
('zalo', 'zalo', 'zalo', 'zalo', 'zalo', 'Zalo', '', 'Zalo', 1752944348, 0, 1, '', '', '', '', 'fa-solid fa-z', '3', 3, 1, '', 0, 0);
...
(1, 1, 'admin', 'admin', '', '', 1754154078, 0, 1, 0);
...
INSERT INTO `nv4_vi_news_tmp` (`id`, `type`, `new_id`, `admin_id`, `time_edit`, `time_late`, `ip`, `uuid`, `properties`) VALUES
(2, 1, 15, 1, 1756014823, 1756014974, '127.0.0.1', '', '{\n    \"id\": 15,\n    \"catid\": 2,\n    \"listcatid\": \"2\",\n    \"topicid\": 0,\n    \"admin_id\": 1,\n    \"author\": \"VINADES\",\n    \"sourceid\": 0,\n    \"addtime\": 1510215907,\n    \"edittime\": 1510215907,\n    \"status\": 4,\n    \"weight\": 15,\n    \"publtime\": 1510215900,\n    \"exptime\": 0,\n    \"archive\": 2,\n    \"title\": \"NukeViet 4.3 có gì mới?\",\n    \"alias\": \"nukeviet-4-3-co-gi-moi\",\n    \"hometext\": \"NukeViet 4.3 là phiên bản nâng cấp của phiên bản NukeViet 4.2 tập trung vào việc fix các vấn đề bất cập còn tồn tại, tối ưu trải nghiệm của người dùng.\",\n    \"homeimgfile\": \"/uploads/news/chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg\",\n    \"homeimgalt\": \"\",\n    \"homeimgthumb\": 1,\n    \"inhome\": 1,\n    \"allowed_comm\": \"4\",\n    \"allowed_rating\": 1,\n    \"external_link\": 1,\n    \"hitstotal\": 2,\n    \"hitscm\": 0,\n    \"total_rating\": 0,\n    \"click_rating\": 0,\n    \"instant_active\": 0,\n    \"instant_template\": \"\",\n    \"instant_creatauto\": 0,\n    \"mode\": \"edit\",\n    \"topictext\": \"\",\n    \"files\": \"\",\n    \"titlesite\": \"\",\n    \"description\": \"\",\n    \"bodyhtml\": \"<p><strong>Hệ thống:</strong><br />- Thay đổi phần quản lý block để dễ dùng hơn khi module có quá nhiều chức năng.<br />- Thêm các tham số cấu hình&nbsp; SSL cho&nbsp; SMTP<br />- Module Upload: Thêm cấu hình có thể chia nhỏ các file khi upload để có thể upload<br />- Plugin:Thêm vị trí chạy sau khi thực hiện module, cải tiến mỗi Plugin sẽ chạy được ở các vị trí nhất định theo người lập trình quy định.<br />- Tích hợp thêm thư viện PDF.js<br />- Thêm tính năng xuất dữ liệu mẫu để khi tiết hành cài đặt có thể dựng luôn site hoàn chỉnh tường tự như cài đặt NukeViet eGovernment<br /><br /><strong>Module comment:&nbsp;</strong><br />- Cho phép cấu hình có sử dụng trình soạn thảo ở phần bình luận hay không.<br />- Cho phép cấu hình có sử dụng file đính kèm ở phần bình luận hay không.<br />- Module news: Allow deactive category, allow search for locked posts, Allows attaching files to posts<br />- Config module display on admin index for authors<br />&nbsp;<br /><strong>Module Tài khoản:</strong><br />- Module users: Allowed to delete and change status multiple account, fix block login, update Openid icon, fix sort groups, fix delete group<br />- Người điều hành chung của site có thể cấu hình 1 số thông số. (Lúc trước chỉ quản trị tối cao mới cấu hình được)<br />- Với mỗi tài khoản quản trị, có thể chọn module mặc định sau khi đăng nhập quản trị.<br /><br /><strong>Module Tin tức:</strong><br />-&nbsp; Thay đổi chức năng quản lý chủ đề có thể: Hiển thị trên trang chủ, không hiển thị trên trang chủ hoặc Khóa chủ đề.<br />-&nbsp; Cho phép đính kèm file vào các bài viết (Không cần thông qua trình soạn thảo)<br />- Thêm tính năng sắp xếp các bài viết.<br />- Cho phép cấu hình layout khi xem chi tiết bài viết (Tưong tự module page đã có trước)<br /><br /><strong>Module page</strong><br />-&nbsp; Thêm cấu hình alias lower khi thêm bài viết mới.<br /><br />Và nhiều cập nhật sửa lỗi khác, xem chi tiết tại: <a href=\\\"https://github.com/nukeviet/nukeviet/blob/develop/CHANGELOG.txt\\\">https://github.com/nukeviet/nukeviet/blob/develop/CHANGELOG.txt</a></p>\",\n    \"voicedata\": [],\n    \"keywords\": \"\",\n    \"sourcetext\": \"https://nukeviet.vn/vi/news/Tin-tuc/nukeviet-4-3-co-gi-moi-540.html\",\n    \"reject_reason\": \"\",\n    \"imgposition\": 2,\n    \"layout_func\": \"\",\n    \"copyright\": 0,\n    \"allowed_send\": 1,\n    \"allowed_print\": 1,\n    \"allowed_save\": 1,\n    \"auto_nav\": 0,\n    \"group_view\": \"\",\n    \"localization\": null,\n    \"related_ids\": \"\",\n    \"related_pos\": 2,\n    \"schema_type\": \"newsarticle\",\n    \"localversions\": [],\n    \"tags\": \"\",\n    \"internal_authors\": []\n}');
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_authors`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_authors`;
CREATE TABLE `nv4_vi_sharecode_authors` (
  `id` int(11) NOT NULL COMMENT 'ID tác giả',
  `userid` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người dùng',
  `username` varchar(100) NOT NULL DEFAULT '' COMMENT 'Tên đăng nhập',
  `display_name` varchar(255) NOT NULL DEFAULT '' COMMENT 'Tên hiển thị',
  `email` varchar(255) NOT NULL DEFAULT '' COMMENT 'Email',
  `phone` varchar(20) NOT NULL DEFAULT '' COMMENT 'Số điện thoại',
  `avatar` varchar(255) NOT NULL DEFAULT '' COMMENT 'Ảnh đại diện',
  `bio` text DEFAULT NULL COMMENT 'Tiểu sử',
  `website` varchar(255) NOT NULL DEFAULT '' COMMENT 'Website cá nhân',
  `facebook` varchar(255) NOT NULL DEFAULT '' COMMENT 'Facebook',
  `twitter` varchar(255) NOT NULL DEFAULT '' COMMENT 'Twitter',
  `linkedin` varchar(255) NOT NULL DEFAULT '' COMMENT 'LinkedIn',
  `github` varchar(255) NOT NULL DEFAULT '' COMMENT 'GitHub',
  `skills` text DEFAULT NULL COMMENT 'Kỹ năng (JSON)',
  `total_sources` int(11) NOT NULL DEFAULT 0 COMMENT 'Tổng số mã nguồn',
  `total_sales` int(11) NOT NULL DEFAULT 0 COMMENT 'Tổng số bán',
  `total_earnings` decimal(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Tổng thu nhập',
  `rating` decimal(3,2) NOT NULL DEFAULT 0.00 COMMENT 'Đánh giá trung bình',
  `total_reviews` int(11) NOT NULL DEFAULT 0 COMMENT 'Tổng số đánh giá',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'Trạng thái (0: Khóa, 1: Hoạt động)',
  `featured` tinyint(4) NOT NULL DEFAULT 0 COMMENT 'Tác giả nổi bật (0: Không, 1: Có)',
  `verified` tinyint(4) NOT NULL DEFAULT 0 COMMENT 'Xác thực (0: Chưa, 1: Đã xác thực)',
  `join_time` int(11) NOT NULL DEFAULT 0 COMMENT 'Thời gian tham gia',
  `last_active` int(11) NOT NULL DEFAULT 0 COMMENT 'Lần hoạt động cuối',
  `weight` int(11) NOT NULL DEFAULT 0 COMMENT 'Thứ tự sắp xếp'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng quản lý tác giả';

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_cart`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_cart`;
CREATE TABLE `nv4_vi_sharecode_cart` (
  `id` int(11) NOT NULL COMMENT 'ID giỏ hàng',
  `user_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người dùng (0 = guest)',
  `session_id` varchar(100) DEFAULT '' COMMENT 'Session ID cho guest',
  `source_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID sản phẩm',
  `quantity` int(11) DEFAULT 1 COMMENT 'Số lượng (luôn = 1 cho digital products)',
  `price` decimal(15,2) DEFAULT 0.00 COMMENT 'Giá tại thời điểm thêm vào cart',
  `added_time` int(11) DEFAULT 0 COMMENT 'Thời gian thêm vào cart',
  `updated_time` int(11) DEFAULT 0 COMMENT 'Thời gian cập nhật'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng giỏ hàng';

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_categories`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_categories`;
CREATE TABLE `nv4_vi_sharecode_categories` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_categories`
--

INSERT INTO `nv4_vi_sharecode_categories` (`id`, `parentid`, `title`, `alias`, `description`, `image`, `weight`, `status`, `add_time`, `edit_time`) VALUES
(2, 0, 'Html & Template', 'html-template', '', '', 1, 1, 1759060095, 0),
(3, 0, 'Android', 'android', '', '', 2, 1, 1759060145, 0),
(4, 0, 'iOS', 'ios', '', '', 3, 1, 1759060152, 0),
(5, 0, 'Cocos2D', 'cocos2d', '', '', 4, 1, 1759060160, 0),
(6, 0, 'Visual C#', 'visual-c', '', '', 5, 1, 1759060170, 0),
(7, 0, 'Windows Phone', 'windows-phone', '', '', 6, 1, 1759060176, 0),
(8, 0, 'Visual C++', 'visual-c-1', '', '', 7, 1, 1759060212, 0),
(9, 0, 'Visual C++', 'visual-c-2', '', '', 8, 1, 1759060221, 0),
(10, 0, 'Asp/Asp.Net', 'aspaspnet', '', '', 9, 1, 1759060232, 0),
(11, 0, 'Visual Basic', 'visual-basic', '', '', 10, 1, 1759060240, 0),
(12, 0, 'WordPress', 'wordpress', '', '', 11, 1, 1759060248, 0),
(13, 0, 'Joomla', 'joomla', '', '', 12, 1, 1759060265, 0),
(14, 0, 'Java/JSP', 'javajsp', '', '', 13, 1, 1759060273, 0),
(15, 0, 'PHP & MySQL', 'php-mysql', '', '', 14, 1, 1759060281, 0),
(16, 0, 'Khác', 'khac', '', '', 15, 1, 1759060292, 0),
(17, 0, 'Unity', 'unity', '', '', 16, 1, 1759060301, 0),
(18, 0, 'Javascript', 'javascript', '', '', 17, 1, 1759060308, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_comments`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_comments`;
CREATE TABLE `nv4_vi_sharecode_comments` (
  `id` int(11) NOT NULL COMMENT 'ID bình luận',
  `source_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID mã nguồn',
  `userid` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người bình luận',
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'Trạng thái (0: ẩn, 1: hiển thị)',
  `parent_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID bình luận cha (cho reply)',
  `admin_reply` text DEFAULT NULL COMMENT 'Phản hồi từ admin',
  `admin_reply_time` int(11) NOT NULL DEFAULT 0 COMMENT 'Thời gian admin phản hồi',
  `admin_reply_userid` int(11) NOT NULL DEFAULT 0 COMMENT 'ID admin phản hồi',
  `ip_address` varchar(39) NOT NULL DEFAULT '' COMMENT 'Địa chỉ IP',
  `user_agent` text DEFAULT NULL COMMENT 'User agent',
  `is_admin` tinyint(4) NOT NULL DEFAULT 0 COMMENT 'Có phải admin comment (0: không, 1: có)'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng bình luận';

--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_comments`
--

INSERT INTO `nv4_vi_sharecode_comments` (`id`, `source_id`, `userid`, `username`, `email`, `content`, `add_time`, `status`, `parent_id`, `admin_reply`, `admin_reply_time`, `admin_reply_userid`, `ip_address`, `user_agent`, `is_admin`) VALUES
(3, 9, 2, 'huydepzai121', '', 'hello', 1759067313, 1, 0, '[{\"content\":\"dsađa\",\"admin_username\":\"admin\",\"time\":1759067741}]', 1759067741, 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_conversations`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_conversations`;
CREATE TABLE `nv4_vi_sharecode_conversations` (
  `id` int(11) NOT NULL COMMENT 'ID cuộc trò chuyện',
  `source_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID sản phẩm',
  `buyer_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người mua',
  `seller_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người bán',
  `last_message_id` int(11) DEFAULT 0 COMMENT 'ID tin nhắn cuối',
  `last_message_time` int(11) DEFAULT 0 COMMENT 'Thời gian tin nhắn cuối',
  `buyer_unread` int(11) DEFAULT 0 COMMENT 'Số tin nhắn chưa đọc của buyer',
  `seller_unread` int(11) DEFAULT 0 COMMENT 'Số tin nhắn chưa đọc của seller',
  `status` tinyint(4) DEFAULT 1 COMMENT 'Trạng thái (1: active, 0: archived)',
  `created_time` int(11) DEFAULT 0 COMMENT 'Thời gian tạo'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng cuộc trò chuyện';

--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_conversations`
--

INSERT INTO `nv4_vi_sharecode_conversations` (`id`, `source_id`, `buyer_id`, `seller_id`, `last_message_id`, `last_message_time`, `buyer_unread`, `seller_unread`, `status`, `created_time`) VALUES
(1, 1, 1, 2, 0, 0, 0, 0, 1, 1756274252);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_download_logs`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_download_logs`;
CREATE TABLE `nv4_vi_sharecode_download_logs` (
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_favorites`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_favorites`;
CREATE TABLE `nv4_vi_sharecode_favorites` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_favorites`
--

INSERT INTO `nv4_vi_sharecode_favorites` (`id`, `userid`, `source_id`) VALUES
(6, 1, 1),
(10, 1, 5);
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_keywords`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_keywords`;
CREATE TABLE `nv4_vi_sharecode_keywords` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL COMMENT 'Tên từ khóa',
  `alias` varchar(255) NOT NULL COMMENT 'Alias URL thân thiện',
  `description` text DEFAULT NULL COMMENT 'Mô tả từ khóa',
  `weight` int(11) NOT NULL DEFAULT 0 COMMENT 'Thứ tự sắp xếp',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Trạng thái (1: hoạt động, 0: tạm khóa)',
  `add_time` int(11) NOT NULL DEFAULT 0 COMMENT 'Thời gian tạo'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng từ khóa';

--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_keywords`
--

INSERT INTO `nv4_vi_sharecode_keywords` (`id`, `name`, `alias`, `description`, `weight`, `status`, `add_time`) VALUES
(1, 'nukeviet', 'nukeviet', '', 1, 1, 1757233849),
(2, 'dsa', 'dsa', '', 2, 1, 1759060803),
(3, 'phpsrw', 'phpsrw', '', 3, 1, 1759060883),
(4, 'dsađấ', 'dsada', '', 4, 1, 1759060883),
(5, 'dsada', 'dsada-1', '', 5, 1, 1759060883),
(6, 'PHP MySQL Website', 'PHP-MySQL-Website', '', 6, 1, 1759066146),
(7, 'Ban Sach Source Code', 'Ban-Sach-Source-Code', '', 7, 1, 1759066146),
(8, 'Full Code Database', 'Full-Code-Database', '', 8, 1, 1759066146),
(9, 'Do An PHP', 'Do-An-PHP', '', 9, 1, 1759066146),
(10, 'E-commerce PHP', 'E-commerce-PHP', '', 10, 1, 1759066146),
(11, 'Web Ban Hang', 'Web-Ban-Hang', '', 11, 1, 1759066146),
(12, 'PHP Project', 'PHP-Project', '', 12, 1, 1759066146),
(13, 'MySQL Database', 'MySQL-Database', '', 13, 1, 1759066146);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_logs`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_logs`;
CREATE TABLE `nv4_vi_sharecode_logs` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_logs`
--

INSERT INTO `nv4_vi_sharecode_logs` (`id`, `userid`, `source_id`, `action`, `ip`, `user_agent`, `log_time`, `details`) VALUES
(1, 1, 5, 'download', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 1757253210, '{\"download_type\":\"external_link\",\"download_url\":\"https:\\/\\/www.facebook.com\\/share\\/p\\/16sE731bep\\/\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/140.0.0.0 Safari\\/537.36\"}'),
(2, 1, 5, 'download', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 1758999633, '{\"download_type\":\"external_link\",\"download_url\":\"https:\\/\\/www.facebook.com\\/share\\/p\\/16sE731bep\\/\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/140.0.0.0 Safari\\/537.36\"}'),
(3, 1, 5, 'download', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 1759041871, '{\"download_type\":\"external_link\",\"download_url\":\"https:\\/\\/www.facebook.com\\/share\\/p\\/16sE731bep\\/\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/140.0.0.0 Safari\\/537.36\"}'),
(4, 2, 5, 'purchase', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 1759047253, '{\"purchase_type\":\"paid\",\"amount\":123000,\"transaction_id\":\"SHARECODE_1759047253_2_5\",\"payment_method\":\"wallet_auto\"}'),
(5, 1, 7, 'download', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 1759060829, '{\"download_type\":\"external_link\",\"download_url\":\"https:\\/\\/www.facebook.com\\/share\\/p\\/16sE731bep\\/\",\"user_agent\":\"Mozilla\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/140.0.0.0 Safari\\/537.36\"}'),
(6, 2, 9, 'purchase', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', 1759067321, '{\"purchase_type\":\"paid\",\"amount\":100000,\"transaction_id\":\"SHARECODE_1759067321_2_9\",\"payment_method\":\"wallet_auto\"}');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_messages`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_messages`;
CREATE TABLE `nv4_vi_sharecode_messages` (
  `id` int(11) NOT NULL COMMENT 'ID tin nhắn',
  `conversation_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID cuộc trò chuyện',
  `sender_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người gửi',
  `receiver_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID người nhận',
  `message` text NOT NULL COMMENT 'Nội dung tin nhắn',
  `message_type` enum('text','image','file') DEFAULT 'text' COMMENT 'Loại tin nhắn',
  `attachment` varchar(255) DEFAULT '' COMMENT 'File đính kèm',
  `is_read` tinyint(4) DEFAULT 0 COMMENT 'Đã đọc (0: chưa, 1: rồi)',
  `sent_time` int(11) DEFAULT 0 COMMENT 'Thời gian gửi',
  `read_time` int(11) DEFAULT 0 COMMENT 'Thời gian đọc'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng tin nhắn';

--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_messages`
--

INSERT INTO `nv4_vi_sharecode_messages` (`id`, `conversation_id`, `sender_id`, `receiver_id`, `message`, `message_type`, `attachment`, `is_read`, `sent_time`, `read_time`) VALUES
(1, 1, 1, 2, 'Xin chào, tôi muốn hỏi về sản phẩm này', 'text', '', 0, 1756274252, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_notifications`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_notifications`;
CREATE TABLE `nv4_vi_sharecode_notifications` (
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_purchases`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_purchases`;
CREATE TABLE `nv4_vi_sharecode_purchases` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_purchases`
--

INSERT INTO `nv4_vi_sharecode_purchases` (`id`, `userid`, `source_id`, `amount`, `author_commission`, `currency`, `payment_method`, `transaction_id`, `status`, `purchase_time`, `payment_time`, `notes`) VALUES
('8615b01fe04b21d035d6de414fc6199f', 2, 5, 123000.00, 0.00, 'VND', 'wallet_auto', 'SHARECODE_1759047253_2_5', 'completed', 1759047253, 1759047253, NULL),
('95d967219e43c2d1817bf4959b101a00', 2, 9, 100000.00, 0.00, 'VND', 'wallet_auto', 'SHARECODE_1759067321_2_9', 'completed', 1759067321, 1759067321, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_reviews`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_reviews`;
CREATE TABLE `nv4_vi_sharecode_reviews` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_reviews`
--

INSERT INTO `nv4_vi_sharecode_reviews` (`id`, `source_id`, `userid`, `username`, `title`, `content`, `rating`, `status`, `add_time`, `edit_time`, `admin_reply`, `admin_reply_time`, `admin_reply_userid`) VALUES
(1, 9, 2, 'huydepzai121', '', 'dsaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 5, 1, 1759067691, 0, 'cảm ơn bạn', 1759067731, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_sources`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_sources`;
CREATE TABLE `nv4_vi_sharecode_sources` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_sources`
--
...
(12, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 4', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-4', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 4', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 13, 1, 0.00, 1, 1, '', 1759066146, 1759060751),
(13, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 5', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-5', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 5', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 8, 1, 0.00, 1, 1, '', 1759066146, 1759060751),
(14, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 6', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-6', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 6', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 8, 1, 0.00, 1, 1, '', 1759066146, 1759060751),
(15, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 7', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-7', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 7', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 8, 1, 0.00, 1, 1, '', 1759066146, 1759060751),
(16, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 8', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-8', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 8', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 15, 1, 0.00, 1, 1, '', 1759066146, 1759060751),
(17, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 9', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-9', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 9', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 18, 1, 0.00, 1, 1, '', 1759066146, 1759060751),
(18, 7, 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 10', 'code-do-an-code-php-mysql-website-ban-sach-full-code-database-moi-nhat-2025-10', 'Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 10', '<p style=\"margin-left:0px;\">Website Bán Sách bao có...</p>', '/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437.jpg', '', '[\"/uploads/sharecode/code-do-an-code-php-mysql-website-ban-sach-full-code-mvc-database-22437-1.jpg\"]', '', '', 0, 'https://www.facebook.com/share/p/16sE731bep/', 'external', 'https://github.com/example/ecommerce-template', 'https://diemdanh.io.vn/', 'nukeviet,dsa,PHP MySQL Website,Ban Sach Source Code,Full Code Database,Do An PHP,E-commerce PHP,Web Ban Hang,PHP Project,MySQL Database', 'paid', 100000.00, '', '', '', '', '', '', '', '', 10, 1, 0.00, 1, 1, '', 1759066146, 1759060751);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_source_keywords`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_source_keywords`;
CREATE TABLE `nv4_vi_sharecode_source_keywords` (
  `source_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID mã nguồn',
  `keyword_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID từ khóa'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng liên kết mã nguồn và từ khóa';

--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_source_keywords`
--

INSERT INTO `nv4_vi_sharecode_source_keywords` (`source_id`, `keyword_id`) VALUES
(1, 1),
(3, 1),
(4, 1),
(5, 1),
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_source_tags`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_source_tags`;
CREATE TABLE `nv4_vi_sharecode_source_tags` (
  `source_id` int(11) NOT NULL DEFAULT 0 COMMENT 'ID mã nguồn',
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_source_tags`
--

INSERT INTO `nv4_vi_sharecode_source_tags` (`source_id`, `tag_id`) VALUES
(1, 1),
(2, 1),
(3, 1),
(4, 1),
...
--
-- Cấu trúc bảng cho bảng `nv4_vi_sharecode_tags`
--

DROP TABLE IF EXISTS `nv4_vi_sharecode_tags`;
CREATE TABLE `nv4_vi_sharecode_tags` (
...
--
-- Đang đổ dữ liệu cho bảng `nv4_vi_sharecode_tags`
--

INSERT INTO `nv4_vi_sharecode_tags` (`id`, `name`, `alias`, `description`, `weight`, `status`, `total_sources`, `add_time`, `edit_time`) VALUES
(1, 'nukeviet', 'nukeviet', '', 0, 1, 5, 1757233849, 0),
(2, 'php', 'php', '', 0, 1, 1, 1759060803, 0),
(3, 'java', 'java', '', 0, 1, 1, 1759060803, 0),
(4, 'dsada', 'dsada', '', 0, 1, 1, 1759060883, 0),
(5, 'dsađa', 'dsada', '', 0, 1, 1, 1759060883, 0),
(6, 'dsadsada', 'dsadsada', '', 0, 1, 1, 1759060883, 0),
(7, 'MySQL', 'MySQL', '', 0, 1, 1, 1759066146, 0),
(8, 'Website', 'Website', '', 0, 1, 1, 1759066146, 0),
(9, 'E-commerce', 'E-commerce', '', 0, 1, 1, 1759066146, 0),
(10, 'Bookstore', 'Bookstore', '', 0, 1, 1, 1759066146, 0),
(11, 'Source Code', 'Source-Code', '', 0, 1, 1, 1759066146, 0);
...
(2, 'Bạn biết gì về NukeViet 4?', '', 1, 0, 1, '6', 1752944348, 0, 1, 0),
(3, 'Lợi ích của phần mềm nguồn mở là gì?', '', 1, 0, 1, '6', 1752944348, 0, 1, 0);
...
(5, 'MBBANK', 'NGUYỄN THẾ HUY', '105120024668', '/uploads/wallet/logo_mb_new.png', 'dsadsa', 'dsada', 1, 'https://sharecode.vn');
...
(1, 1684770292, 0, 1, 'VND', 19868888768, 3621660, 19865267108, '', ''),
(2, 1753026829, 1, 1, 'VND', 2600000, 622000, 1978000, '', ''),
(3, 1757090151, 0, 1, 'VND', 280000000000, 100000, 279999900000, '', ''),
...
(473, 1752995784, 1, 'VND', 19867868768, 19867868768, 0, 19867868768, 1, 1, 0, 0, '', '', '', '', '', '', 1, 4, 1752995784, '', '', '', '', '', 0, '', 1),
(474, 1753007975, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: ', 'TXNC1642E46FE', -1, 4, 1753007975, '', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"\",\"timestamp\":1753007975,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(475, 1753008002, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: ', 'TXNB9E3CE95DE', -1, 4, 1753008002, '', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"\",\"timestamp\":1753008002,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(476, 1753008061, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: ', 'TXN02ED5B2026', -1, 4, 1753008061, '', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"\",\"timestamp\":1753008061,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(477, 1753019718, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: ', 'TXN38E4208C7D', -1, 4, 1753019718, '', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"\",\"timestamp\":1753019718,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(478, 1753020457, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXN48FD6998BC', -1, 4, 1753020457, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753020457,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(479, 1753020653, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXND475DB90C4', -1, 4, 1753020653, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753020653,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(480, 1753020719, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXN1C0C4D94B1', -1, 4, 1753020719, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753020719,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(481, 1753023758, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXN5770608662', -1, 4, 1753023758, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753023758,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(482, 1753023854, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXNF664976378', -1, 4, 1753023854, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753023854,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(483, 1753024156, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXND13DD82090', -1, 4, 1753024156, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753024156,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(484, 1753024210, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXNA4C88C91B3', -1, 4, 1753024210, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753024210,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(485, 1753024849, -1, 'VND', -199000, -199000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXND81B5D2BF2', -1, 4, 1753024849, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753024849,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(486, 1753026829, 1, 'VND', 200000, 200000, 0, 200000, 2, 1, 0, 0, '', '', '', '', '', '', 0, 4, 1753026829, '', '', '', '', '', 0, '', 1),
(487, 1753026863, -1, 'VND', -199000, -199000, 0, 0, 2, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: E-commerce Platform', 'TXN20CB3D6E40', -1, 4, 1753026863, 'Mua mã nguồn: E-commerce Platform', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":199000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: E-commerce Platform\",\"timestamp\":1753026863,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(488, 1753166590, -1, 'VND', -89000, -89000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: React Data Table', 'TXN3793161749', -1, 4, 1753166590, 'Mua mã nguồn: React Data Table', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":89000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: React Data Table\",\"timestamp\":1753166590,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(489, 1755621465, -1, 'VND', -100000, -100000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'TXN85EDB1FD54', -1, 4, 1755621465, 'Mua mã nguồn: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"timestamp\":1755621465,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(490, 1755621689, 1, 'VND', 2000000, 2000000, 0, 2000000, 2, 1, 0, 0, '', '', '', '', '', '', 0, 4, 1755621689, 'dsada', '', '', '', '', 0, '', 1),
(491, 1755621701, -1, 'VND', -100000, -100000, 0, 0, 2, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'TXNBB17EC3223', -1, 4, 1755621701, 'Mua mã nguồn: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"timestamp\":1755621701,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1);
INSERT INTO `nv4_wallet_transaction` (`id`, `created_time`, `status`, `money_unit`, `money_total`, `money_net`, `money_discount`, `money_revenue`, `userid`, `adminid`, `order_id`, `customer_id`, `customer_name`, `customer_email`, `customer_phone`, `customer_address`, `customer_info`, `transaction_id`, `transaction_type`, `transaction_status`, `transaction_time`, `transaction_info`, `transaction_data`, `payment`, `provider`, `tokenkey`, `is_expired`, `detail_money`, `status_tb`) VALUES
(492, 1755621920, -1, 'VND', -100000, -100000, 0, 0, 2, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'TXN293D611855', -1, 4, 1755621920, 'Mua mã nguồn: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: dsadaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"timestamp\":1755621920,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(493, 1756752771, -1, 'VND', -100000, -100000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: website test', 'TXN9C0C5D0B20', -1, 4, 1756752771, 'Mua mã nguồn: website test', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: website test\",\"timestamp\":1756752771,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(494, 1757002689, -1, 'VND', -100000, -100000, 0, 0, 1, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: dsadadad', 'TXN9882B29FAB', -1, 4, 1757002689, 'Mua mã nguồn: dsadadad', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: dsadadad\",\"timestamp\":1757002689,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(495, 1757089807, 1, 'VND', 100000, 100000, 0, 100000, 2, 1, 0, 0, '', '', '', '', '', '', 1, 4, 1757089807, '2313', '', '', '', '', 0, '{\"userid\":2,\"created_time\":1753026829,\"created_userid\":1,\"status\":1,\"money_unit\":\"VND\",\"money_in\":2200000,\"money_out\":399000,\"money_total\":1801000,\"note\":\"\",\"tokenkey\":\"\"}', 0),
(496, 1757089808, 1, 'VND', 100000, 100000, 0, 100000, 2, 1, 0, 0, '', '', '', '', '', '', 1, 4, 1757089808, '2313', '', '', '', '', 0, '{\"userid\":2,\"created_time\":1753026829,\"created_userid\":1,\"status\":1,\"money_unit\":\"VND\",\"money_in\":2300000,\"money_out\":399000,\"money_total\":1901000,\"note\":\"\",\"tokenkey\":\"\"}', 0),
(497, 1757089808, 1, 'VND', 100000, 100000, 0, 100000, 2, 1, 0, 0, '', '', '', '', '', '', 1, 4, 1757089808, '2313', '', '', '', '', 0, '{\"userid\":2,\"created_time\":1753026829,\"created_userid\":1,\"status\":1,\"money_unit\":\"VND\",\"money_in\":2400000,\"money_out\":399000,\"money_total\":2001000,\"note\":\"\",\"tokenkey\":\"\"}', 0),
(498, 1757089809, 1, 'VND', 100000, 100000, 0, 100000, 2, 1, 0, 0, '', '', '', '', '', '', 1, 4, 1757089809, '2313', '', '', '', '', 0, '{\"userid\":2,\"created_time\":1753026829,\"created_userid\":1,\"status\":1,\"money_unit\":\"VND\",\"money_in\":2500000,\"money_out\":399000,\"money_total\":2101000,\"note\":\"\",\"tokenkey\":\"\"}', 0),
(499, 1757090151, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 2, 'Nguyễn Hải', '', '', '', '', '', -1, 4, 1757090151, 'dsada', '', '', '', '', 0, 'false', 1),
(500, 1757090347, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 2, 'Nguyễn Hải', '', '', '', '', '', -1, 4, 1757090347, 'dsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":10000000000,\"money_out\":0,\"money_total\":10000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(501, 1757090349, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 2, 'Nguyễn Hải', '', '', '', '', '', -1, 4, 1757090349, 'dsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":20000000000,\"money_out\":0,\"money_total\":20000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(502, 1757090349, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 2, 'Nguyễn Hải', '', '', '', '', '', -1, 4, 1757090349, 'dsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":30000000000,\"money_out\":0,\"money_total\":30000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(503, 1757090356, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 2, 'Nguyễn Hải', '', '', '', '', '', -1, 4, 1757090356, 'dsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":40000000000,\"money_out\":0,\"money_total\":40000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(504, 1757090372, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090372, 'dsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":50000000000,\"money_out\":0,\"money_total\":50000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(505, 1757090438, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090438, 'dsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":60000000000,\"money_out\":0,\"money_total\":60000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(506, 1757090475, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090475, 'dsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":70000000000,\"money_out\":0,\"money_total\":70000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(507, 1757090480, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090480, 'dsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":80000000000,\"money_out\":0,\"money_total\":80000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(508, 1757090490, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090490, 'dsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":90000000000,\"money_out\":0,\"money_total\":90000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(509, 1757090507, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090507, 'dsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":100000000000,\"money_out\":0,\"money_total\":100000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(510, 1757090515, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090515, 'dsadsadsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":110000000000,\"money_out\":0,\"money_total\":110000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(511, 1757090582, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090582, 'dsadsadsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":120000000000,\"money_out\":0,\"money_total\":120000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(512, 1757090644, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090644, 'dsadsadsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":130000000000,\"money_out\":0,\"money_total\":130000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(513, 1757090928, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757090928, 'dsadsadsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":140000000000,\"money_out\":0,\"money_total\":140000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(514, 1757091474, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091474, 'dsadsadsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":150000000000,\"money_out\":0,\"money_total\":150000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(515, 1757091475, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091475, 'dsadsadsa', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":160000000000,\"money_out\":0,\"money_total\":160000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(516, 1757091477, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091477, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":170000000000,\"money_out\":0,\"money_total\":170000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(517, 1757091478, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091478, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":180000000000,\"money_out\":0,\"money_total\":180000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(518, 1757091478, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091478, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":190000000000,\"money_out\":0,\"money_total\":190000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(519, 1757091478, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091478, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":200000000000,\"money_out\":0,\"money_total\":200000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(520, 1757091479, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091479, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":210000000000,\"money_out\":0,\"money_total\":210000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(521, 1757091479, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091479, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":220000000000,\"money_out\":0,\"money_total\":220000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(522, 1757091529, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091529, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":230000000000,\"money_out\":0,\"money_total\":230000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(523, 1757091529, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091529, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":240000000000,\"money_out\":0,\"money_total\":240000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(524, 1757091530, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091530, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":250000000000,\"money_out\":0,\"money_total\":250000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(525, 1757091612, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', -1, 4, 1757091612, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":260000000000,\"money_out\":0,\"money_total\":260000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(526, 1757091688, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', 1, 4, 1757091688, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":270000000000,\"money_out\":0,\"money_total\":270000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(527, 1757091689, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', 1, 4, 1757091689, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":270000000000,\"money_out\":0,\"money_total\":270000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(528, 1757091768, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', 1, 4, 1757091768, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":270000000000,\"money_out\":0,\"money_total\":270000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(529, 1757091773, 1, 'VND', 10000000000, 10000000000, 0, 10000000000, 3, 0, 0, 3, 'Nguyễn Thế Huy 1', 'nguyenthehuy97794sdad3@gmail.com', '', '', '', '', 1, 4, 1757091773, 'dsadsadsada', '', '', '', '', 0, '{\"userid\":3,\"created_time\":1757090151,\"created_userid\":0,\"status\":1,\"money_unit\":\"VND\",\"money_in\":270000000000,\"money_out\":0,\"money_total\":270000000000,\"note\":\"\",\"tokenkey\":\"\"}', 1),
(530, 1757091807, -1, 'VND', -100000, -100000, 0, 0, 3, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: dsadadad', 'TXN3039E957C7', -1, 4, 1757091807, 'Mua mã nguồn: dsadadad', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: dsadadad\",\"timestamp\":1757091807,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(531, 1759047253, -1, 'VND', -123000, -123000, 0, 0, 2, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: test website', 'TXNDD2D5A69DB', -1, 4, 1759047253, 'Mua mã nguồn: test website', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":123000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: test website\",\"timestamp\":1759047253,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1),
(532, 1759067321, -1, 'VND', -100000, -100000, 0, 0, 2, 0, 0, 0, '', '', '', '', 'API deduction: Mua mã nguồn: Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 1', 'TXN20BB4C72B0', -1, 4, 1759067321, 'Mua mã nguồn: Code đồ án Code PHP & MySQL Website Bán Sách Full code + Database mới nhất 2025 1', '{\"api_call\":true,\"source\":\"DeductBalance API\",\"amount\":100000,\"currency\":\"VND\",\"description\":\"Mua m\\u00e3 ngu\\u1ed3n: Code \\u0111\\u1ed3 \\u00e1n Code PHP & MySQL Website B\\u00e1n S\\u00e1ch Full code + Database m\\u1edbi nh\\u1ea5t 2025 1\",\"timestamp\":1759067321,\"user_agent\":\"NUKEVIET CMS 5.0.00. Developed by VINADES. Url: https:\\/\\/nukeviet.vn. Code: 6c11c1516ed7040fa12b952aa9d65708\",\"ip_address\":\"127.0.0.1\"}', '', '', '', 0, '', 1);
...
--
-- Cấu trúc bảng cho bảng `nv5_vi_sharecode_comments`
--

DROP TABLE IF EXISTS `nv5_vi_sharecode_comments`;
CREATE TABLE `nv5_vi_sharecode_comments` (
  `id` int(11) NOT NULL,
  ...
  `admin_reply_time` int(11) NOT NULL DEFAULT 0,
  `admin_reply_userid` int(11) NOT NULL DEFAULT 0,
...
--
-- Chỉ mục cho bảng `nv4_users_passkey`
--
ALTER TABLE `nv4_users_passkey`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_modblocks`
--
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_authors`
--
ALTER TABLE `nv4_vi_sharecode_authors`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_cart`
--
ALTER TABLE `nv4_vi_sharecode_cart`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_user_source` (`user_id`,`source_id`),
  ADD UNIQUE KEY `unique_session_source` (`session_id`,`source_id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_session_id` (`session_id`),
  ADD KEY `idx_source_id` (`source_id`),
  ADD KEY `idx_added_time` (`added_time`);

--
-- Chỉ mục cho bảng `nv4_vi_sharecode_categories`
--
ALTER TABLE `nv4_vi_sharecode_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_comments`
--
ALTER TABLE `nv4_vi_sharecode_comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_source_id` (`source_id`),
  ADD KEY `idx_userid` (`userid`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_parent_id` (`parent_id`),
  ADD KEY `idx_add_time` (`add_time`),
  ADD KEY `idx_is_admin` (`is_admin`);

--
-- Chỉ mục cho bảng `nv4_vi_sharecode_conversations`
--
ALTER TABLE `nv4_vi_sharecode_conversations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_conversation` (`source_id`,`buyer_id`,`seller_id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_download_logs`
--
ALTER TABLE `nv4_vi_sharecode_download_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_source_id` (`source_id`),
  ADD KEY `idx_user_id` (`user_id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_favorites`
--
ALTER TABLE `nv4_vi_sharecode_favorites`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_keywords`
--
ALTER TABLE `nv4_vi_sharecode_keywords`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_logs`
--
ALTER TABLE `nv4_vi_sharecode_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_userid` (`userid`),
  ADD KEY `idx_source_id` (`source_id`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_messages`
--
ALTER TABLE `nv4_vi_sharecode_messages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_conversation_id` (`conversation_id`),
  ADD KEY `idx_sender_id` (`sender_id`),
  ADD KEY `idx_receiver_id` (`receiver_id`),
  ADD KEY `idx_sent_time` (`sent_time`),
  ADD KEY `idx_is_read` (`is_read`),
  ADD KEY `idx_conversation_sent_time` (`conversation_id`,`sent_time`);

--
-- Chỉ mục cho bảng `nv4_vi_sharecode_notifications`
--
ALTER TABLE `nv4_vi_sharecode_notifications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_userid` (`userid`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_purchases`
--
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_reviews`
--
ALTER TABLE `nv4_vi_sharecode_reviews`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_source_id` (`source_id`),
  ADD KEY `idx_userid` (`userid`),
  ADD KEY `idx_status` (`status`),
...
--
-- Chỉ mục cho bảng `nv4_vi_sharecode_sources`
--
ALTER TABLE `nv4_vi_sharecode_sources`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_alias` (`alias`(250)),
...
ALTER TABLE `nv4_vi_sharecode_sources` ADD FULLTEXT KEY `idx_title_keywords` (`title`,`keywords`,`description`);

--
-- Chỉ mục cho bảng `nv4_vi_sharecode_source_keywords`
--
ALTER TABLE `nv4_vi_sharecode_source_keywords`
  ADD PRIMARY KEY (`source_id`,`keyword_id`),
  ADD KEY `idx_keyword_id` (`keyword_id`);

--
-- Chỉ mục cho bảng `nv4_vi_sharecode_source_tags`
--
ALTER TABLE `nv4_vi_sharecode_source_tags`
  ADD PRIMARY KEY (`source_id`,`tag_id`),
  ADD KEY `idx_tag_id` (`tag_id`);

--
-- Chỉ mục cho bảng `nv4_vi_sharecode_tags`
--
ALTER TABLE `nv4_vi_sharecode_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv5_vi_sharecode_comments`
--
ALTER TABLE `nv5_vi_sharecode_comments`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `nv4_api_role`
  MODIFY `role_id` smallint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `nv4_upload_dir`
  MODIFY `did` mediumint(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
-- AUTO_INCREMENT cho bảng `nv4_users_passkey`
--
ALTER TABLE `nv4_users_passkey`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `nv4_vi_blocks_groups`
  MODIFY `bid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
-- AUTO_INCREMENT cho bảng `nv4_vi_news_tmp`
--
ALTER TABLE `nv4_vi_news_tmp`
...
--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_authors`
--
ALTER TABLE `nv4_vi_sharecode_authors`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID tác giả';

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_cart`
--
ALTER TABLE `nv4_vi_sharecode_cart`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID giỏ hàng';

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_categories`
--
ALTER TABLE `nv4_vi_sharecode_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID danh mục', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_comments`
--
ALTER TABLE `nv4_vi_sharecode_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID bình luận', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_conversations`
--
ALTER TABLE `nv4_vi_sharecode_conversations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID cuộc trò chuyện', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_download_logs`
--
ALTER TABLE `nv4_vi_sharecode_download_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID log tải xuống';

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_favorites`
--
ALTER TABLE `nv4_vi_sharecode_favorites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID yêu thích', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_keywords`
--
ALTER TABLE `nv4_vi_sharecode_keywords`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_logs`
--
ALTER TABLE `nv4_vi_sharecode_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID log', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_messages`
--
ALTER TABLE `nv4_vi_sharecode_messages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID tin nhắn', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_notifications`
--
ALTER TABLE `nv4_vi_sharecode_notifications`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID thông báo';

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_reviews`
--
ALTER TABLE `nv4_vi_sharecode_reviews`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID đánh giá', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_sources`
--
ALTER TABLE `nv4_vi_sharecode_sources`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID mã nguồn', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `nv4_vi_sharecode_tags`
--
ALTER TABLE `nv4_vi_sharecode_tags`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID thẻ tag', AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT cho bảng `nv5_vi_sharecode_comments`
--
ALTER TABLE `nv5_vi_sharecode_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
