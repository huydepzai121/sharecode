...
$lang_module['email_ipn_alert_c'] = '<p>There is an IPN query coming from an unauthorized IP. Below is the information:</p><br /><ul><br />    <li>Payport: <strong>%s</strong></li><br />    <li>IP: <strong>%s</strong></li><br />    <li>Time: <strong>%s</strong></li><br />    <li>User-Agent: <strong>%s</strong></li><br /></ul><br /><p>View more at: <a href="%s">%s</a></p>';
...
$lang_module['account_holder'] = 'Account holder';
$lang_module['account_number'] = 'Account number';
...
$lang_module['error_required_id'] = 'Error: Required fields enter the Id';
$lang_module['error_required_title'] = 'Error: You need to enter the data for the promotion name';
$lang_module['error_required_account_holder'] = 'Error: Required fields enter the Account holder';
$lang_module['error_required_account_number'] = 'Error: Required fields enter the Account number';
$lang_module['error_required_status'] = 'Error: Required fields enter the Status';
$lang_module['save'] = 'Save';
$lang_module['manager_info'] = 'manager_info';
