...
<div class="card">
    <div class="card-header text-bg-primary rounded-top-2 d-flex gap-2 justify-content-between align-items-center">
        ...
        <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#modal-category" data-action="add">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive-lg table-card">
            <table class="table table-striped align-middle table-sticky mb-0">
                ...
                <tbody>
                    ...
                    <tr class="item category-row" data-id="{$category.id}" data-parent="{$category.parentid}" data-level="{$category.level}" {if $category.parentid > 0}style="display: none;"{/if}>
                        <td class="text-center align-middle">
                            <input type="checkbox" data-toggle="checkSingle" name="checkSingle[]" value="{$category.id}" class="form-check-input m-0 align-middle" aria-label="Chọn danh mục">
                        </td>
                        <td class="text-center align-middle">
                            <span class="badge bg-primary change-weight-btn"
                                  style="cursor: pointer;"
                                  data-id="{$category.id}"
                                  data-current="{$category.weight}"
                        ...
                        <td class="align-middle">
                            <div class="d-flex align-items-center">
                                ...
                                {if $category.has_children}
                                    <button type="button" class="btn btn-sm btn-link p-0 me-2 category-toggle" data-id="{$category.id}">
                                ...
                                <div>
                                    <div class="fw-medium category-title {if $category.has_children}category-expandable{/if}" data-id="{$category.id}">
                                        {$category.title}
                                    </div>
                                    {if $category.alias}<div class="text-muted small">/{$category.alias}</div>{/if}
                                    {if $category.description}<div class="text-muted small mt-1">{$category.description|truncate:80}</div>{/if}
                                </div>
                            </div>
                        </td>
                        <td class="text-center align-middle">
                        ...
                        <td class="text-center align-middle">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-sm btn-outline-secondary" title="Chỉnh sửa" data-bs-toggle="modal" data-bs-target="#modal-category" data-action="edit" data-id="{$category.id}">
                                    <i class="fa-solid fa-pen"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-danger" title="Xóa" data-toggle="delCategory" data-id="{$category.id}" data-checksess="{$category.checksess}">
        ...
        <div class="alert alert-info mb-0" role="alert">
            ...
            <button type="button" class="btn btn-sm btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#modal-category" data-action="add">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <div class="d-flex flex-wrap flex-sm-nowrap align-items-center">
                ...
                <div class="input-group me-1 my-1">
                    ...
                    <button class="btn btn-primary" type="button" id="element_action_btn" data-toggle="actionCategory">Thực hiện</button>
                </div>
            </div>
            <div class="text-muted small">
...
<div class="modal fade" id="modal-image-preview" tabindex="-1" aria-labelledby="modal-image-preview-label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-category" novalidate>
                    ...
                    <div class="mb-3">
                        <label for="modal-title" class="form-label">Tên danh mục <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <input type="text" class="form-control required" id="modal-title" name="title" maxlength="255" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-secondary" type="button" id="btn-generate-alias" data-bs-toggle="tooltip" data-bs-title="Tự động tạo từ tên danh mục">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="image-preview" class="mt-2 d-none">
                            <img id="preview-img" src="" alt="Preview" class="img-thumbnail" style="max-width: 150px; max-height: 100px;">
                    ...
                    <div class="mb-0">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="modal-status" name="status" value="1" checked>
...
<style>
.category-indent[data-level="1"] { margin-left: 20px; }
.category-indent[data-level="2"] { margin-left: 40px; }
.category-indent[data-level="3"] { margin-left: 60px; }
.category-indent[data-level="4"] { margin-left: 80px; }
.category-indent[data-level="5"] { margin-left: 100px; }
