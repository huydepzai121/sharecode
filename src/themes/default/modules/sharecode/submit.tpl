                ...
                <div class="form-sections">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-textarea" rows="8" placeholder="Mô tả chi tiết về sản phẩm, tính năng, công nghệ sử dụng...">{DATA.description}</textarea>
                            <small class="form-help">Mô tả càng chi tiết càng tăng khả năng bán hàng</small>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Từ khóa SEO:</label>
                            <input type="text" name="keywords" class="form-input" placeholder="web, php, javascript, bootstrap" value="{DATA.keywords}">
                            <small class="form-help">Các từ khóa cách nhau bởi dấu phẩy</small>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Tags:</label>
                            <input type="text" name="tags" class="form-input" placeholder="responsive, admin panel, ecommerce" value="{DATA.tags}">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group external-link" style="display: none;">
                            ...
                            <input type="url" name="download_link" class="form-input" placeholder="https://drive.google.com/..." value="{DATA.download_link}">
