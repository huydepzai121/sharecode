...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="d-flex align-items-center mb-4">
                <div class="me-3">
                    <i class="fa fa-user-cog fa-2x text-primary"></i>
                </div>
                <div>
                    <h2 class="mb-0 fw-bold">{LANG.editinfo_pagetitle}</h2>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-2">
                    <ul class="nav nav-pills nav-fill flex-column flex-sm-row" id="userProfileTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {BASIC_ACTIVE}" id="basic-tab" data-bs-toggle="pill" data-bs-target="#edit_basic" type="button" role="tab" data-location="{EDITINFO_FORM}/basic">
                                <i class="fa fa-user me-2"></i>{LANG.edit_basic}
                            </button>
                        </li>
                        <!-- BEGIN: edit_avatar -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {AVATAR_ACTIVE}" id="avatar-tab" data-bs-toggle="pill" data-bs-target="#edit_avatar" type="button" role="tab" data-location="{EDITINFO_FORM}/avatar">
                                <i class="fa fa-image me-2"></i>{LANG.edit_avatar}
                            </button>
                        </li>
                        <!-- END: edit_avatar -->
                        <!-- BEGIN: edit_username -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {USERNAME_ACTIVE}" id="username-tab" data-bs-toggle="pill" data-bs-target="#edit_username" type="button" role="tab" data-location="{EDITINFO_FORM}/username">
                                <i class="fa fa-at me-2"></i>{LANG.edit_login}
                            </button>
                        </li>
                        <!-- END: edit_username -->
                        <!-- BEGIN: edit_email -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {EMAIL_ACTIVE}" id="email-tab" data-bs-toggle="pill" data-bs-target="#edit_email" type="button" role="tab" data-location="{EDITINFO_FORM}/email">
                                <i class="fa fa-envelope me-2"></i>{LANG.edit_email}
                            </button>
                        </li>
                        <!-- END: edit_email -->
                        <!-- BEGIN: edit_password -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {PASSWORD_ACTIVE}" id="password-tab" data-bs-toggle="pill" data-bs-target="#edit_password" type="button" role="tab" data-location="{EDITINFO_FORM}/password">
                                <i class="fa fa-lock me-2"></i>{LANG.edit_password}
                            </button>
                        </li>
                        <!-- END: edit_password -->
                        <!-- BEGIN: edit_passkey -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {PASSKEY_ACTIVE}" id="passkey-tab" data-bs-toggle="pill" data-bs-target="#edit_passkey" type="button" role="tab" data-location="{EDITINFO_FORM}/passkey">
                                <i class="fa fa-key me-2"></i>{LANG.edit_passkey}
                            </button>
                        </li>
                        <!-- END: edit_passkey -->
                        <!-- BEGIN: edit_langinterface -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {LANGINTERFACE_ACTIVE}" id="lang-tab" data-bs-toggle="pill" data-bs-target="#edit_langinterface" type="button" role="tab" data-location="{EDITINFO_FORM}/langinterface">
                                <i class="fa fa-language me-2"></i>{GLANG.langinterface}
                            </button>
                        </li>
                        <!-- END: edit_langinterface -->
                        <!-- BEGIN: 2step -->
                        <li class="nav-item">
                            <a href="{URL_2STEP}" class="nav-link">
                                <i class="fa fa-shield me-2"></i>{LANG.2step_status}
                            </a>
                        </li>
                        <!-- END: 2step -->
                        <!-- BEGIN: edit_question -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {QUESTION_ACTIVE}" id="question-tab" data-bs-toggle="pill" data-bs-target="#edit_question" type="button" role="tab" data-location="{EDITINFO_FORM}/question">
                                <i class="fa fa-question-circle me-2"></i>{LANG.edit_question}
                            </button>
                        </li>
                        <!-- END: edit_question -->
                        <!-- BEGIN: edit_openid -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {OPENID_ACTIVE}" id="openid-tab" data-bs-toggle="pill" data-bs-target="#edit_openid" type="button" role="tab" data-location="{EDITINFO_FORM}/openid">
                                <i class="fa fa-openid me-2"></i>{LANG.openid_administrator}
                            </button>
                        </li>
                        <!-- END: edit_openid -->
                        <!-- BEGIN: edit_group -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {GROUP_ACTIVE}" id="group-tab" data-bs-toggle="pill" data-bs-target="#edit_group" type="button" role="tab" data-location="{EDITINFO_FORM}/group">
                                <i class="fa fa-users me-2"></i>{LANG.group}
                            </button>
                        </li>
                        <!-- END: edit_group -->
                        <!-- BEGIN: edit_others -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {OTHERS_ACTIVE}" id="others-tab" data-bs-toggle="pill" data-bs-target="#edit_others" type="button" role="tab" data-location="{EDITINFO_FORM}/others">
                                <i class="fa fa-cogs me-2"></i>{LANG.edit_others}
                            </button>
                        </li>
                        <!-- END: edit_others -->
                        <!-- BEGIN: edit_safemode -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {SAFEMODE_ACTIVE}" id="safemode-tab" data-bs-toggle="pill" data-bs-target="#edit_safemode" type="button" role="tab" data-location="{EDITINFO_FORM}/safemode">
                                <i class="fa fa-shield-alt me-2"></i>{LANG.safe_mode}
                            </button>
                        </li>
                        <!-- END: edit_safemode -->
                        <!-- BEGIN: edit_forcedrelogin -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {FORCEDRELOGIN_ACTIVE}" id="forcedrelogin-tab" data-bs-toggle="pill" data-bs-target="#edit_forcedrelogin" type="button" role="tab" data-location="{EDITINFO_FORM}/forcedrelogin">
                                <i class="fa fa-sign-out-alt me-2"></i>{LANG.forcedrelogin}
                            </button>
                        </li>
    ...
    <div class="tab-content">
        <div id="edit_basic" class="tab-pane fade {TAB_BASIC_ACTIVE}" role="tabpanel">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{EDITINFO_FORM}/basic" method="post" role="form" data-toggle="reg_validForm" autocomplete="off" novalidate>
                        <div class="alert alert-info border-0 d-none" role="alert" data-default="">
                            <i class="fa fa-info-circle me-2"></i><span></span>
                        </div>
                        <div class="row">
                            <!-- BEGIN: name_show_0 -->
                            <!-- BEGIN: show_last_name-->
                            <div class="col-md-6 mb-3">
                                <label for="last_name" class="form-label fw-semibold">{FIELD.title}</label>
                                ...
                                <!-- BEGIN: description --><div class="small form-text text-muted">{FIELD.description}</div><!-- END: description -->
                            </div>
                            <!-- END: show_last_name -->
                            <!-- BEGIN: show_first_name -->
                            <div class="col-md-6 mb-3">
                                <label for="first_name" class="form-label fw-semibold">{FIELD.title}</label>
                            ...
                            <!-- BEGIN: show_gender -->
                            <div class="col-md-6 mb-3">
                                <label for="gender" class="form-label fw-semibold">{FIELD.title}</label>
                                <select class="form-select {FIELD.required} {FIELD.class}" name="gender" data-toggle="validErrorHidden" data-event="change" data-mess="">
                                    <!-- BEGIN: gender -->
                            ...
                            <!-- BEGIN: show_birthday -->
                            <div class="col-md-6 mb-3">
                                <label for="birthday" class="form-label fw-semibold">{FIELD.title}</label>
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker {FIELD.required} {FIELD.class}" name="birthday" value="{FIELD.value}" readonly="readonly" style="background-color: #fff" data-focus="datepickerShow" data-mess="">
                            ...
                            <div class="col-12 mb-3">
                                <label for="sig" class="form-label fw-semibold">{FIELD.title}</label>
                                <textarea class="form-control {FIELD.required} {FIELD.class}" placeholder="{FIELD.title}" name="sig" rows="3" data-toggle="validErrorHidden" data-event="keypress" data-mess="">{FIELD.value}</textarea>
                                <!-- BEGIN: description --><div class="small form-text text-muted">{FIELD.description}</div><!-- END: description -->
                            </div>
                            <!-- END: show_sig -->
                            <div class="col-12 mb-4">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="view_mail" id="view_mail" value="1" {DATA.view_mail}>
                                    <label class="form-check-label" for="view_mail">{LANG.showmail}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 text-center">
                            <a href="{GROUP_MANAGE.link}" class="btn btn-link">
                                <i class="fa fa-caret-right me-2"></i>{GROUP_MANAGE.title}
                            </a>
                        </div>
        ...
        <div id="edit_avatar" class="tab-pane fade {TAB_AVATAR_ACTIVE}" role="tabpanel">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    <div class="mb-4">
                        <div class="position-relative d-inline-block">
                            <img id="myavatar" alt="My Avatar" class="img-thumbnail shadow" src="{DATA.photo}" width="{DATA.photoWidth}" height="{DATA.photoHeight}" data-default="{AVATAR_DEFAULT}" style="max-width: 200px; max-height: 200px;" />
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        <button type="button" class="btn btn-primary" data-toggle="changeAvatar" data-url="{URL_AVATAR}">
                            <i class="fa fa-upload me-2"></i>{LANG.change_avatar}
                        </button>
                        <button type="button" class="btn btn-outline-danger" id="delavatar" data-toggle="deleteAvatar" data-obj="#myavatar" data-ss="{DATA.checkss}"{DATA.imgDisabled}>
                            <i class="fa fa-trash me-2"></i>{GLANG.delete}
                        </button>
                    </div>
                </div>
            </div>
