        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th colspan="2"><h4>{LANG.select_pay}</h4></th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- BEGIN: smsNap -->
                        ...
                        <tr>
                            <td>
                               <a title="{DATA_PAYMENT.name}" href="#" class="im" data-toggle="paymentsel" data-payment="{DATA_PAYMENT.payment}"><img src="{DATA_PAYMENT.images_button}" alt="{DATA_PAYMENT.name}" width="200px" /></a>
                            </td>
                            <td>
                                <a title="{DATA_PAYMENT.name}" href="#" data-toggle="paymentsel" data-payment="{DATA_PAYMENT.payment}">{DATA_PAYMENT.name}</a>
                            </td>
                        </tr>
                        <!-- END: paymentloop -->
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="hidden payment-guide-item" id="payment-guide-{DATA_PAYMENT.payment}">
                                    <span>{DATA_PAYMENT.name}</span>
                                    <!-- BEGIN: guide -->
                                    <div class="form-group">{DATA_PAYMENT.guide}</div>
                                    <!-- END: guide -->
                                    <div class="text-center">
                                        <a href="{DATA_PAYMENT.url}" class="btn btn-primary" style="display: inline-block;">{LANG.continue}</a>
                                    </div>
                                </div>
                            </td>
                        </tr>   
