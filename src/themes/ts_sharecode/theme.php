...
function nv_site_theme($contents, $full = true)
{
    ...
    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css_custom/sweetalert.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/toastr/toastr.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/css/style.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/animate.css/animate.min.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/owl.carousel/assets/owl.carousel.min.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/remixicon/remixicon.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/boxicons/css/boxicons.min.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/icofont/icofont.min.css'
    ];
    ...
    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/bootstrap/css/bootstrap.min.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => '/assets/js/select2/select2.min.css'
    ];

    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/aos/aos.css'
    ];
    ...
    // CSS cho module sharecode
    if ($module_name == 'sharecode') {
        $html_links[] = array(
            'rel' => 'StyleSheet',
            'href' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/css/sharecode.css'
        );
    }
    ...
    $html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/js/sweetalert.min.js'
    ];

    $html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/toastr/toastr.js'
    ];

    $html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/toastr/tienganh.js'
    ];

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/jquery/jquery.min.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/php-email-form/validate.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/bootstrap/js/bootstrap.bundle.min.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/waypoints/jquery.waypoints.min.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/counterup/counterup.min.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/jquery.easing/jquery.easing.min.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/owl.carousel/owl.carousel.min.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/js/main.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/assets/vendor/aos/aos.js'
    );

    $html_js[] = array(
        'ext' => 1,
        'content' =>'/assets/js/select2/select2.min.js'
    );
